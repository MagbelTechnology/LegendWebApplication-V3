...
public class Transaction implements Serializable {
  ...
  private String assetTransfer;
  private String finaclePost;
  private String improvement;
  private String approval;
  private String disposal;
  private String acceleDepr;
    public Transaction(String id, String debitAccount, String creditAccount,
    ...
    public Transaction(String id,String assetId, String assetTransfer, String finaclePost,
            String improvement, String disposal, String approval,String tranType,String acceleDepr) {

setId(id); 
setAssetId(assetId); 
setAssetTransfer(assetTransfer);
setFinaclePost(finaclePost);
setImprovement(improvement);
setApproval(approval);
setDisposal(disposal);
setTranType(tranType);
setAcceleDepr(acceleDepr);
    }
    
    public Transaction(String id,String assetId, String description, String debitAccount,
            String creditAccount, double amount, String effectiveDate,String tranType,String fullName) {
...
public Transaction(String debitAccount,
...
public Transaction(String assetId, String description, String barCode){
		setAssetId(assetId);
		setDescription(description);
		setBarCode(barCode);
		}
...
public Transaction(){
  ...
  public void setSentTime(String sentTime)
  {
	...
	public String getAssetTransfer() {
		return assetTransfer;
	}
	public void setAssetTransfer(String assetTransfer) {
		this.assetTransfer = assetTransfer;
	}
	
	public String getFinaclePost() {
		return finaclePost;
	}
	public void setFinaclePost(String finaclePost) {
		this.finaclePost = finaclePost;
	}
	...
	public String getAcceleDepr() {
		return acceleDepr;
	}
	public void setAcceleDepr(String acceleDepr) {
		this.acceleDepr = acceleDepr;
	}	
}
