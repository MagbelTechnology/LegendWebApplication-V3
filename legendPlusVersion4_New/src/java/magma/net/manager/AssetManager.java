...
public class AssetManager extends MagmaDBConnection {
    ...
    public ArrayList findClassifiedAssetByQuery(String queryFilter) {
        ...
        String selectQuery =
                ...
                "WHERE a.ASSET_ID = r.NEW_ASSET_ID AND (r.status != 'RR' OR r.status is null) " + queryFilter;
    ...
    //String updateOldAsset_query ="";
     ...
     Connection con = null;
        ...
        try {
            ...
            ps.setDouble(14, Double.parseDouble(transferedAsset[13]));//to be zerolised, need to revert to old status,i.e no zerolisation
...
public ReclassifiedAsset findReclassifiedAssetById(String assetid,int tranId) {
