...
public class ExcelStaffUploadManager extends MagmaDBConnection
{
    ...
    public ExcelStaffUploadManager(String uid)
    {
        userid = uid;
 //       tranType = transType;
    ...
    private void insertCellContents(Cell cell[])
    {
        ...
        try
        {
            ...
            staffId = cell[1].getContents();      
            fullName = cell[2].getContents();
            deptCode = cell[3].getContents();
            branchCode = cell[4].getContents();
            createdBy =  cell[5].getContents();
...
//        System.out.println("<<<<<<<result: "+result+"    sNo: "+sNo);
     //   String deleterecord = approve.getCodeName("DELETE FROM am_uploadCheckErrorLog WHERE TRANSACTION_TYPE = 'Asset Creation'");
        String existuser = approve.getCodeName("SELECT count(*) FROM am_gb_Staff WHERE STAFFID = '"+staffId+"'");
       ...
       // 	result = true;        	
        ...
        errorMessage = "Record "+sNo+" User Already Exist: "+error;
        
        String branchcodeValid = approve.getCodeName("select BRANCH_NAME from am_ad_branch where BRANCH_CODE = '"+branchCode+"'");
      //  System.out.println("<<<<<<< branchcodeValid:  "+branchcodeValid);
        ...
        errorMessage = errorMessage+"branch_code:"+error;
...
//    			System.out.println("<<<<<<<branch: "+branch+"   branchCode: "+branchCode+"   userClass: "+userClass);
    ...
    private void addCellContent(Staffs user)
    {
        int staux = 0;
        try
        {
