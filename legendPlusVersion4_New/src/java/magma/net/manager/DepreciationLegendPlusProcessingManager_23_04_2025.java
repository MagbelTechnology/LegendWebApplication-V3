...
public class DepreciationLegendPlusProcessingManager_23_04_2025 extends MagmaDBConnection
{
    ...
    public DepreciationLegendPlusProcessingManager_23_04_2025()
    {
        Alist = new ArrayList();
...
//        System.out.println("<<<<<<<<<<<<<nextprocessDate: "+nextprocessDate);
        ...
        String threshold = htmlCombo.findObject("SELECT cost_threshold FROM AM_GB_COMPANY");
