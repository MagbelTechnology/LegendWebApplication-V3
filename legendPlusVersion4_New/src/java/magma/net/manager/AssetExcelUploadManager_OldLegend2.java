...
public class AssetExcelUploadManager_OldLegend2 extends MagmaDBConnection
{
    ...
    public AssetExcelUploadManager_OldLegend2(String uid)
    {
        userid = uid;
    ...
    private void insertCellContents(Cell cell[])
    {
        ...
        try
        {
            ...
            sub_category_code = cell[4].getContents();
