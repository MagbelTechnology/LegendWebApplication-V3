 ...
 * @version 1.0
 */
public class UncapitalisFleetHistoryManager extends MagmaDBConnection {
    ...
    public UncapitalisFleetHistoryManager() {
        super();
  ...
  private MagmaDBConnection dbConnection = new MagmaDBConnection();
    ...
    public ArrayList findAssetForDepreciation() {
        ...
        String selectQuery =
                ...
                "FROM AM_ASSET_UNCAPITALIZED  WHERE Req_Depreciation = 'Y'";
    ...
    public ArrayList findAssetByCategory(String categoryCode) {
        ...
        String selectQuery =
                ...
                "RESIDUAL_VALUE,POSTING_DATE,RAISE_ENTRY,DEP_YTD,SECTION , " +
                "NBV,REMAINING_LIFE,TOTAL_LIFE,EFFECTIVE_DATE   " +
                "FROM AM_ASSET_UNCAPITALIZED WHERE CATEGORY_ID = ? ";
    ...
    public ArrayList findAssetByMakeCategory(String categoryCode,
        ...
        String selectQuery =
                ...
                "FROM AM_ASSET_UNCAPITALIZED A,AM_AD_CATEGORY C " +
    ...
    public ArrayList findAssetByQuery(String queryFilter) {
        ...
        String selectQuery_old =
         ...
         String selectQuery =
                ...
                "FROM AM_ASSET_UNCAPITALIZED  WHERE ASSET_ID IS NOT NULL AND ASSET_STATUS = 'ACTIVE' " + queryFilter;
    ...
    public AssetDetail findAssetDetailById(String id) {
        ...
        String selectQuery =
                ...
                "FROM AM_ASSET_UNCAPITALIZED A,FT_FLEET_MASTER F,AM_AD_BRANCH B   " +
    ...
    public boolean isRequiredForFleet(String id) {
        ...
        String selectQuery = "SELECT B.REQUIRED_FOR_FLEET        " +
                             "FROM AM_ASSET_UNCAPITALIZED A, AM_AD_CATEGORY B " +
    ...
    public String getAssetStatusForCombo(String status) {
        ...
        String SELECT_QUERY = "SELECT DISTINCT(ASSET_STATUS) FROM AM_ASSET_UNCAPITALIZED";
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    private String getDataMigrationQuery() {
        return "INSERT INTO FM_MASTER(" +
                ...
                ",SECTION_CODE,DEPT_CODE,CATEGORY_CODE,DESCRIPTION   FROM AM_ASSET_UNCAPITALIZED    " +
                "WHERE ASSET_ID = ?";
...
//modification by lanre
   public ArrayList findAssetForDepreciation(String filter) {
		...
		String selectQuery =
			...
			"FROM AM_ASSET_UNCAPITALIZED  WHERE Req_Depreciation = 'Y' " + filter;
  ...
  */
    ...
    public ArrayList findAssetBIDByQuery(String queryFilter){
        ...
        String selectQuery_old =
         ...
         String selectQuery =
                ...
                "system_ip,mac_address,Bid_Period,BID " +
    ...
    public boolean InsertBidSelection(ArrayList list) {
        ...
        String query = "insert into AM_ASSET_BID_SELECTION("+
                ...
                "Asset_Engine_No,Location,Bid_Value,Useage_Years,Asset_Status,First_Name,Sur_Name,Category_Id,Bid_Code,Address_1,Address_2,Phone_No,Email_Address,Initials,Creation_Date)" +
                "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            for(int i = 0; i < list.size(); i++) {
				...
				String firstname = bd.getFirstname();
				 if(firstname == null || engno.equals("")){
					 firstname = "";
	                }
...
public boolean InsertBidLimit(ArrayList list) {
    ...
    try {
       ...
       //System.out.println("Executed Successfully ");
        ...
        System.out.println("Error InsertBidLimitIn FleetHistoryManager -> " + ex);
    } finally {
        dbConnection.closeConnection(con, ps);
    }
...
public ArrayList findAssetByQueryy(String queryFilter) {
       ...
       String query =
        ...
        "LPO,supervisor,defer_pay,OLD_ASSET_ID,WHT_PERCENT,Post_reject_reason,Finacle_Posted_Date," +
        "system_ip,mac_address " +
        "FROM AM_ASSET_UNCAPITALIZED  where ASSET_ID NOT IN (select Asset_Id from am_asset_bid) "+queryFilter;
...
public boolean insertBID(ArrayList list) {
       ...
       // DateFormat dfs = new SimpleDateFormat("dd/MM/yyyy");
        String query = "insert into AM_ASSET_BID("+
                ...
                "Post_reject_reason,Finacle_Posted_Date,system_ip,mac_address,Bid_Start_Date,Bid_End_Date,BID,Creation_Date)" +
                "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
//        	 System.out.print("DID IT GOT HERE ??????????? PART 2 "+selectQuery);
 ...
 public boolean createBidSorting(magma.net.vao.Asset asset) {
...
+"Useage_Years,Asset_Status,First_Name,Sur_Name,Category_Id,Bid_Code,Address_1,Address_2,Email_Address,Phone_No,Initials from AM_ASSET_BID_SELECTION order by ASSET_ID,Description,BID_Value,Useage_Years,Date_purchased";
		 ...
		 /* String query2  = "insert into AM_BID_RESULT(Asset_id,Registration_No,Description,Vendor_AC,Date_purchased,Asset_Make,Asset_Model,Asset_Serial_No,Asset_Engine_No,Location,Bid_Value, "
		  ...
		  String query2 ="insert into am_bid_result(Bid_Code,Asset_id,Registration_No,Description,Vendor_Ac,Date_Purchased,Asset_Make,Asset_Model,Asset_Serial_No,Asset_Engine_No,Location,Bid_Value, "
		  		+"Category_Id,Useage_Years,Asset_Status,First_Name,Sur_Name,Address_1,Address_2,Email_Address,Phone_No,Initials,Creation_Date)"
		  		...
		  		+"s.Creation_Date from AM_ASSET_BID_SELECTION s,AM_BID_LIMIT l where s.asset_id = l.asset_id and bid_value >=bid_limit ";


		  //String UPDATE_QUERY = "UPDATE AM_BID_RECORD_DETAIL SET Bid_Title =?,Bid_Date=? WHERE Registration_No = ?";

		  String UPDATE_QUERY2 = "UPDATE AM_BID_RESULT SET Bid_Title=?,Bid_Date=?,User_Id=?,Ip_Address=?,Mac_Address=? WHERE Registration_No = ?";
			...
			//	ps3 = con.prepareStatement(query3);
				//psd = con.prepareStatement(UPDATE_QUERY);
				ps2 = con.prepareStatement(UPDATE_QUERY2);

				//psd.setString(1,asset.getBidtitle());
				//psd.setDate(2, df.dateConvert(asset.getBiddate()));
				//psd.setString(3,asset.getUsername());
				//psd.setString(4,asset.getPassword());
				//psd.setString(3, "0");
				//done =(ps.executeUpdate()!=-1);
				//done1 = psd.execute();
				done2 =(ps1.executeUpdate()!=-1);
				//done3 =(ps3.executeUpdate()!=-1);
				ps2.setString(1, asset.getBidtitle());
				ps2.setDate(2,df.dateConvert(asset.getBiddate()));
				ps2.setString(3, asset.getId());
				ps2.setString(4, asset.getAddress1());
				ps2.setString(5, asset.getAddress1());
				ps2.setString(6, "0");
 ...
 public ArrayList findAssetBIDRESULT(String queryFilter){
   ...
   // String selectQuery ="select asset_id,Asset_Model,Asset_Status,Description,Bid_Date,Bid_Title," +
    ...
    String selectQuery ="select asset_id,Asset_Model,Asset_Status,Description,Bid_Date,Bid_Title," +
	"max(bid_Value)Bid_Value from AM_BID_RESULT group by asset_id, " +
	"Asset_Model,Asset_Status,Description,Bid_Date,Bid_Title "+queryFilter;
     // System.out.println("the query is <<<<<<<<<<<<< "+ selectQuery);
      Connection con = null;
      PreparedStatement ps = null;
 ...
 public boolean createBIDPeriod(magma.net.vao.Bid_Period period) {
	...
	String query = "INSERT INTO AM_BID_Period_SetUp(BID_Start_Date,BID_End_Date"
			+ " ,BID_Title,User_Id,create_date,Status)"
			+ " VALUES(?,?,?,?,?,?)";

	try {
		con = getConnection("legendPlus");
		ps = con.prepareStatement(query);
		ps.setDate(1, df.dateConvert(period.getStartDate()));
		ps.setDate(2, df.dateConvert(period.getEndDate()));
 ...
 public java.util.List getBidPeriodByQuery(String filter) {
	...
	String query = "SELECT BID_Start_Date,BID_End_Date,BID_Title,User_Id"
			+ "  ,Create_Date,Status"
