...
public class MagmaDBConnection implements eConnection {
    ...
    public void closeConnection(Connection con, PreparedStatement ps) {
        try {
            ...
            System.out.println("WARNING:Error closing Connection parameter -1 ->" +
                               e.getMessage());
        }
    ...
    public void closeConnection(Connection con, Statement ps) {
           try {
               ...
               System.out.println("WARNING:Error closing Connection two Parameter ->" +
                                  e.getMessage());
           }

    }

    public void closeConnection(Statement ps) {
        try {
            if (ps != null) {
                ps.close();
            }
        } catch (Exception e) {
            System.out.println("WARNING:Error closing Connection One Parameter ->" +
                               e.getMessage());
        }
