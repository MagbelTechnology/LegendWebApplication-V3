...
public class descriptionservlet extends HttpServlet {
    ...
    {
        String subcategoryId = request.getParameter("addsubcatId");
...
//           String query = "select sbu_code, sbu_code+' - '+SBU_NAME from AM_SBU_ATTACHEMENT where ATTACH_ID = ? order by sbu_name" ;
           String query ="SELECT DESCRIPTION,DESCRIPTION AS NARRATION  FROM AM_ASSET_DESCRIPTION WHERE SUB_CATEGORY_CODE = '"+subcategoryId+"' ORDER BY DESCRIPTION";
	      ...
	      rs = ps.executeQuery();
           while(rs.next()) {
            out.write("<make>");
                ...
                out.write("</name>");
             out.write("</make>");
//               System.out.println("The value of Description is LLLLLLLLLLLLLLLLLL"+rs.getString(2));
           }
