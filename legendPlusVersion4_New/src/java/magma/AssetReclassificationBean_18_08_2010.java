 ...
 * @version 1.0
 */
public class AssetReclassificationBean_18_08_2010 extends legend.ConnectionClass {
    ...
    public AssetReclassificationBean_18_08_2010() throws Exception {
        super();
     ...
     * @return boolean
     */
    public boolean insertAssetReclassification(boolean budget) throws Exception {
        ...
        String insertQuery = "INSERT INTO AM_ASSETRECLASSIFICATION(" +
                ...
                "new_dep_end_date,old_total_life,old_remaining_life,new_monthly_dep)" +
                " VALUES(?, ?, ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
       ...
       // double vatableCost = (vatable_cost == null || vatable_cost.equals("")) ? 0.0 : Double.parseDouble(vatable_cost.replaceAll(",", ""));
        ...
        int totalLife = (int) ((100 / Double.parseDouble(getDepreciationRate(new_category))) * 12);
        double oldNBV1 = (oldNBV == null || oldNBV.equals("")) ? 0.0 : Double.parseDouble(oldNBV);
        int remainingLife = totalLife - (old_total_life - old_remaining_life);
    ...
    */
    ...
    public void updateBudget() {
        ...
        Connection conn = dbConnect.getConnection("fixedasset");
        ;
        //Statement stmt = null;
        try {
