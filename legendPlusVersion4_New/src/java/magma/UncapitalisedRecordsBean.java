 ...
 * @version 1.0
 */
public class UncapitalisedRecordsBean extends legend.ConnectionClass 
{ 
    ...
    public UncapitalisedRecordsBean() throws Exception {
...
public String checkCategoryCode()
    ...
    Connection con = null;
        ...
        ResultSet rs = null;
         ...
         String query =
                "SELECT CATEGORY_CODE FROM AM_ASSET_UNCAPITALIZED" ;
...
public String checkBranchCode()
    ...
    Connection con = null;
        ...
        ResultSet rs = null;
         ...
         String query =
                "SELECT BRANCH_CODE FROM AM_ASSET_UNCAPITALIZED" ;
...
//String q ="select asset_id, asset_status,user_ID,supervisor,Cost_Price,Posting_Date,description,effective_date,BRANCH_CODE from AM_ASSET_UNCAPITALIZED where asset_id ='" +id+"'";
   String[] result= new String[12];
    Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;

         String query ="select asset_id,user_ID,supervisor,Cost_Price,Posting_Date,description,effective_date,BRANCH_CODE,Asset_Status from AM_ASSET_UNCAPITALIZED where asset_id ='" +id+"'"; ;
...
public void updateGroupAssetMainStatusChange(long id,String status)
{
	...
	{
		String branch="";
		String query="SELECT BRANCH_CODE FROM AM_ASSET_UNCAPITALIZED where Asset_id='"+Asset_id+"'";
	...
	{
		String category="";
		String query="SELECT CATEGORY_CODE FROM AM_ASSET_UNCAPITALIZED  where Asset_id='"+Asset_id+"'";
...
*/
    	public boolean checkApprovalStatus(String id)
	{
            ...
            String asset_status="";
		String query="SELECT asset_status FROM AM_ASSET_UNCAPITALIZED where asset_id ='"+id+"'";
    ...
    Connection con = null;
        ...
        ResultSet rs = null;
         ...
         String query ="select asset_id,user_ID,supervisor,Cost_Price,Posting_Date,description," +
                 "effective_date,BRANCH_CODE,Asset_Status from AM_ASSET_UNCAPITALIZED where asset_id ='" +id+"'"; ;
...
result[9] = "Uncapitalise Close Asset";
result[10] = "P";
...
public int changeAssetID(String oldAssetId,String newAssetId)
    ...
    String query_r ="update AM_ASSET_UNCAPITALIZED set asset_id = ? where ASSET_ID=? ";
...
public boolean updateAsset(String assetId,String userId) throws Exception {
    ...
    String query = "update AM_ASSET_UNCAPITALIZED set " +
                   ...
                   "wh_tax=? ,wh_tax_amount=? ,BRANCH_ID=? ,MULTIPLE=? ,COST_PRICE=?," +
                   "BRANCH_CODE=?,DEPT_CODE=?,SECTION_CODE=? ,CATEGORY_CODE=?,WAR_START_DATE=?," +
                   "WAR_MONTH=?,WAR_EXPIRY_DATE=?, BAR_CODE=? ,SBU_CODE=? , LPO=? , supervisor=?, defer_pay=? ,category_id=?,dep_rate=?,wht_percent=? where asset_id=? and user_id=? " ;
...
System.out.println("vatable_cost "+vatable_cost);
        ...
        ps.setString(57, assetId);
        ps.setString(58,userId);
        ps.execute();

    } catch (Exception ex) {
        done = false;
        System.out.println("AssetRecordsBean: updateasset():WARN:Error updating to AM_ASSET_UNCAPITALIZED table->" + ex);
    } finally {
        dbConnection.closeConnection(con, ps);
    }
    return done;
    ...
    public String vendorName (String assetId)
		{
			...
			String query="select  vendor_name from am_ad_vendor where vendor_id=" +
                    "(select supplier_name from AM_ASSET_UNCAPITALIZED where asset_id='"+assetId+"')";
 ...
 public void getAssetRecordsForApprovalArchive(String assetId, String update_changes) throws Exception {
        ...
        if (!(assetId.equalsIgnoreCase(""))) {
         ...
         "ASSET_MAINTENANCE = ?, AUTHORIZED_BY = ? , SUPPLIER_NAME = ?, PURCHASE_REASON = ?,"+
          ...
          "BAR_CODE = ?, LPO = ?, wht_percent=? WHERE ASSET_ID = ? ";
        ...
        if (!(assetId.equalsIgnoreCase(""))) {
            ...
            try {
                ...
                if(update_changes.equalsIgnoreCase("YES")){
                    ...
                    String updateQuery = "UPDATE AM_ASSET_UNCAPITALIZED SET REGISTRATION_NO = ?," +
         "ASSET_MAINTENANCE = ?, AUTHORIZED_BY = ? , SUPPLIER_NAME = ?, PURCHASE_REASON = ?,"+
          "DESCRIPTION = ?, VENDOR_AC = ? , ASSET_SERIAL_NO = ?, ASSET_MODEL = ?,"+
          "USER_ID = ?, SUBJECT_TO_VAT = ? , WHO_TO_REM = ?, EMAIL1 = ?,"+
          "EMAIL2 = ?, WH_TAX = ? , SPARE_1 = ?, SPARE_2 = ?,"+
...
*/
    ...
    String createQuery = "INSERT INTO AM_ASSET_UNCAPITALIZED         " +
                         ...
                         "BRANCH_CODE,DEPT_CODE,SECTION_CODE,CATEGORY_CODE,	AMOUNT_PTD," +
                         "AMOUNT_REM,PART_PAY,FULLY_PAID,BAR_CODE,SBU_CODE,LPO,supervisor,defer_pay,wht_percent," +
                         "system_ip,mac_address,asset_code) " +
...
public boolean rinsertAssetMemoRecord() throws Exception, Throwable {
        ...
        try 
		{
            ...
            "system_ip,mac_address,asset_code,memo,oldId) " +
