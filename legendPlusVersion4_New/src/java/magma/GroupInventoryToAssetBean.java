...
public class GroupInventoryToAssetBean extends legend.ConnectionClass 
{
...
private String memoValue="";
   ...
   // private String status = "A";
    ...
    public GroupInventoryToAssetBean() throws Exception {
        super();
    ...
    public void fetch(String s) throws Exception {
        ...
        String fetchQuery = "SELECT ASSET_ID,REGISTRATION_NO," +
                            ...
                            " SUB_CATEGORY_ID,SPARE_3, SPARE_4, SPARE_5, SPARE_6 FROM AM_GROUP_ASSET  " +
                            "WHERE ASSET_ID = '" + s + "'";
