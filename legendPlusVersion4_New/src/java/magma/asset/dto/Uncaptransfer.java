...
public class Uncaptransfer {
    ...
    public Uncaptransfer(int transferId, String assetId, String deptName, String branchName,
    ...
    public Uncaptransfer(int transferId, String assetId, int deptId, String deptName,
                    int branchId,
