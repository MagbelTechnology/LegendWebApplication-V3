...
public class UncapitaliseTransfer {
    ...
    public UncapitaliseTransfer(int transferId, String assetId, int sectionId, String user, 
    		String raiseEntry, String transferDate,
            int userId, String datePurchased, String effDate, int branchId, int deptId,
    ...
    public UncapitaliseTransfer(int transferId, String assetId, int deptId,
                    int branchId, int sectionId, 
                    String user, String raiseEntry,
                    String transferDate, int userId, 
    ...
    public UncapitaliseTransfer(int transferId, String assetId, int deptId,
                    ...
                    String datePurchased, String regNo, String effDate,
                    int categoryId, String assetUser, String assetStatus,
                    int newBranch_Id, int newDept_Id, int newSection_Id) {
        setTransferId(transferId);
        setAssetId(assetId);
        setDeptId(deptId);
        setBranchId(branchId);
