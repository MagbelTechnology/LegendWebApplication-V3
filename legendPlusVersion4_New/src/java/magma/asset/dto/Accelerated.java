...
public class Accelerated implements Serializable {
  ...
  public Accelerated(String assetId, String regNo, int branchId,String branchName,int deptId,
               ...
               String subj2Vat,String subj2Wht,double vatableCost,int usefullife,int totallife,int remainlife) 
  {
  ...
  public Accelerated(String assetId, String regNo, int branchId,String branchName,int deptId,
               ...
               String effDate,String vendorAcct,String model,String engineNo,String email1,String email2,
               String whoToRem1,String whoToRem2,String reqReDistbtn,double vatAmt,double whtAmt,
               String subj2Vat,String subj2Wht,double vatableCost,String integrify,int usefullife,int totallife,int remainlife) 
  {
