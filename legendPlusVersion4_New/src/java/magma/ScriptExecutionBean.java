...
public class ScriptExecutionBean {
	...
	/*
	public static java.util.ArrayList<ScriptExecutionBeans> getScriptExecDetails(String userId) throws SQLException {
		java.util.ArrayList<ScriptExecutionBeans> list = new java.util.ArrayList<ScriptExecutionBeans>();
		Connection con = null ;
...
//        	}
	  ...
	  private static void closeConnection(Connection con, PreparedStatement ps, ResultSet rs)
		...
		public static java.util.ArrayList getScriptExecDetails(String userId) throws SQLException {
		//	java.util.ArrayList<ScriptExecutionBeans> list = new java.util.ArrayList<ScriptExecutionBeans>();
		    ...
		    rs = ps.executeQuery();
		    if(rs.next()) {
		    	ScriptExecutionBean scriptExecutionBean = new ScriptExecutionBean();
		    	String script = rs.getString(1);
		    	String reason = rs.getString(2);
		    	String confirm = rs.getString(3);
