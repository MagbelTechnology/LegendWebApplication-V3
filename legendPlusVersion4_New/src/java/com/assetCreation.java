...
@GET 
@Path("/getNewAssetCreationDetails")
@Produces(MediaType.APPLICATION_JSON) 
public String assetCreation(@QueryParam("INTEGRIFY_ID") String strintegrifyId,
@QueryParam("Description") String strDescription,
@QueryParam("Registration_No") String strRegistrationNo,
@QueryParam("Vendor_AC") String strVendorAC,
@QueryParam("Date_purchased") String strDatepurchased,
@QueryParam("Asset_Make") String strAssetMake,
@QueryParam("Asset_Model") String strAssetModel,
@QueryParam("Asset_Serial_No") String strAssetSerialNo,
@QueryParam("Asset_Engine_No") String strAssetEngineNo,
@QueryParam("Supplier_Name") String strSupplierName,
@QueryParam("Asset_User") String strAssetUser,
@QueryParam("Asset_Maintenance") String strAssetMaintenance,
@QueryParam("Cost_Price") double strCostPrice,
@QueryParam("Authorized_By") String strAuthorizedBy,
@QueryParam("Wh_Tax") String strWhTax,
@QueryParam("Posting_Date") String strPostingDate,
@QueryParam("Effective_Date") String strEffectiveDate,
@QueryParam("Purchase_Reason") String strPurchaseReason,
@QueryParam("Subject_TO_Vat") String strSubjectTOVat,
@QueryParam("Asset_Status") String strAssetStatus,
@QueryParam("State") String strState,
@QueryParam("Driver") String strDriver,
@QueryParam("User_ID") String strUserID,
@QueryParam("BRANCH_CODE") String strbranchCode,
@QueryParam("SECTION_CODE") String strsectionCode,
@QueryParam("DEPT_CODE") String strdeptCode,
@QueryParam("CATEGORY_CODE") String strcategoryCode,
@QueryParam("SUB_CATEGORY_CODE") String strsubcategoryCode,
@QueryParam("BAR_CODE") String strbarCode,
@QueryParam("SBU_CODE") String strsbuCode,
@QueryParam("LPO") String strlpo,
@QueryParam("INVOICE_NO") String strinvoiceNo,
@QueryParam("supervisor") String strsupervisor,
@QueryParam("POSTED") String Strposted,
@QueryParam("ASSET_ID") String StrassetId,
@QueryParam("ASSET_CODE") String StrassetCode,
@QueryParam("ERROR_MESSAGE") String Strerrormessage,
@QueryParam("ASSET_TYPE") String Strassettype,
@QueryParam("TRAN_TYPE") String Strtrantype,
@QueryParam("Wh_Tax_Value") double StrwhTaxValue,
@QueryParam("Vat_Value") double StrVatValue,
@QueryParam("QUANTITY") int Strnoofitems,  
@QueryParam("Location") String Strlocation,
@QueryParam("Spare_1") String Strspare1,
@QueryParam("Spare_2") String Strspare2,
@QueryParam("Spare_3") String Strspare3,
@QueryParam("Spare_4") String Strspare4,
@QueryParam("Spare_5") String Strspare5,
@QueryParam("Spare_6") String Strspare6,
@QueryParam("Multiple") String Strmultiple,
@QueryParam("Memo") String Strmemo,
@QueryParam("MemoValue") String Strmemovalue,
@QueryParam("IMPROV_USEFULLIFE") int Strusefullife,
@QueryParam("PROJECT_CODE") String projectcode,
@QueryParam("LOCATION")String Location, 
@QueryParam("System_IP")String systemIP) throws Throwable {
System.out.println("Starting to call asset creation!!!");
 ...
 try
    {  
     ...
     java.util.ArrayList list = records.getNewAssetSqlRecordsForCapitalised(
    		 strintegrifyId, strDescription, strRegistrationNo, strVendorAC, strSupplierName,
			  strDatepurchased, strAssetMake, strAssetUser, strAssetModel, strAssetEngineNo, 
			   strUserID, strCostPrice, strEffectiveDate, strAssetSerialNo, strAssetMaintenance, 
			   strAuthorizedBy, strWhTax, StrwhTaxValue, StrVatValue, strPostingDate,
				strPurchaseReason, strSubjectTOVat, strAssetStatus, strState, strDriver,  
				strUserID, strbranchCode,  strsectionCode, strdeptCode, strcategoryCode,
				strsubcategoryCode, strbarCode, strsbuCode, strlpo, strinvoiceNo,
					Strposted, StrassetId, StrassetCode, strsupervisor, systemIP, Strerrormessage,
					Strassettype, Strtrantype, Strnoofitems, Strlocation, Strspare1, Strspare2, 
			Strspare3, Strspare4, Strspare5, Strspare6, Strmemo, Strmemovalue, Strmultiple, Strusefullife, projectcode);
		...
		//		 System.out.println(".:  "+integrifyIdexist);
				...
				//	 double TotalCostPrice = Double.parseDouble(comp.findObject("select sum(cost_price) from NEW_GROUP_ASSET_INTERFACE where INTEGRIFY_ID = '"+integrifyId+"' AND ASSET_TYPE = 'U'"));
				 ...
				 if(assettype.equalsIgnoreCase("C")&& errorMessage.equalsIgnoreCase("") && (noofitems!=0)){
					 ...
					 String costPrice = String.valueOf(strCostPrice);
