...
{    
	...
	private int quantity;
        ...
        private String requestDescriptionNew;
    	...
    	public Sla3(String ReqnID, String priority) {
    		super();
    		this.ReqnID = ReqnID;
    ...
    public String getRequestDescriptionNew() {
        return requestDescriptionNew;
    }

    public void setRequestDescriptionNew(String requestDescriptionNew) {
        this.requestDescriptionNew = requestDescriptionNew;
    }
