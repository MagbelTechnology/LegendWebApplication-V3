...
public class User {
 ...
 //   private String organizationName;
    ...
    private String isHelpdesk;
    private String Technician;
    private String PageNo;
    private String organContact;
    public String getIsHelpdesk() {
        return isHelpdesk;
    }

    public void setIsHelpdesk(String isHelpdesk) {
    ...
    /**
     * @param organContact the organContact to set
     */
