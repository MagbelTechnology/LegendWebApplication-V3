...
public class HelpDeskNewRequisitionGuestServlet extends HttpServlet {
    Connection con = null;
    Connection cn = null;
    ...
    public HelpDeskNewRequisitionGuestServlet() {
        super();
    }
...
//        String responseMode = "001";
        ...
        // try {
             ...
             cn = mgDbCon.getConnection("helpDesk");
...
//                String Status = aprecords.getCodeName(StatusQry);
              ...
              //  	 System.out.println("<<<<<< NOT doneSave url >>>>>> "+url);
                    ...
                    out.print("<script>window.location='DocumentHelp.jsp?np=hdNewRequisitionFormGuest&reportId="+returncode+"&reqnId='</script>");
