 ...
 */
public class LostPasswordServletNext extends HttpServlet {
...
//			{
		...
		//get the new password format for validation
          ...
          /*            
			 ...
			 if(usb.changePassword4(user.getUserId(),passWordNew,String.valueOf(comp_param.getPasswordExpiry()),comp_param.getPasswordLimit()))
				{
