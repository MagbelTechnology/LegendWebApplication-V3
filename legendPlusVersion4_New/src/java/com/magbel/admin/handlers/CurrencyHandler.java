...
com.magbel.admin.objects.ExchangeRate exchange = null;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                exchange = new com.magbel.admin.objects.ExchangeRate();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String status = rs.getString("status");
                 String method = rs.getString("method");
                exchange = new
com.magbel.admin.objects.ExchangeRate();
                exchange.setCreate_dt(createdt);
                exchange.setCurrency_id(currid);
                exchange.setEffective_dt(effdate);
                exchange.setExchg_rate(rate);
    ...
    public com.magbel.admin.objects.ExchangeRate getExchangeRateByCurrID(String curryid) {
        //java.util.ArrayList _list = new java.util.ArrayList();
...
com.magbel.admin.objects.ExchangeRate exchange = null;
    ...
    public com.magbel.admin.objects.ExchangeRate getExchangeRateByMTID(String curryid) {
        //java.util.ArrayList _list = new java.util.ArrayList();
        com.magbel.admin.objects.ExchangeRate exchange = null;
        String query = "SELECT MTID,currency_id,create_dt"
                       + ",effective_dt,exchg_rate"
    ...
    public java.util.ArrayList getAllCurrency() {
        java.util.ArrayList _list = new java.util.ArrayList();
        com.magbel.admin.objects.CurrencyCode curcode = null;
        ...
        try {
           c = getConnection();
            ...
            while (rs.next()) {
                ...
                curcode = new com.magbel.admin.objects.CurrencyCode(currid, isocode,
    ...
    public com.magbel.admin.objects.CurrencyCode getCurrencyByCurrID(String currencyid) {
        //java.util.ArrayList _list = new java.util.ArrayList();
        com.magbel.admin.objects.CurrencyCode curcode = null;
        String query = "SELECT currency_id,iso_code,currency_symbol"
                       +
    ...
    public com.magbel.admin.objects.CurrencyCode findLocalCurrency() {
        //java.util.ArrayList _list = new java.util.ArrayList();
        com.magbel.admin.objects.CurrencyCode curcode = null;
        String query = "SELECT currency_id,iso_code,currency_symbol"
                       +
    ...
    public com.magbel.admin.objects.CurrencyCode getCurrencyByMTID(String mtidy) {
        //java.util.ArrayList _list = new java.util.ArrayList();
        com.magbel.admin.objects.CurrencyCode curcode = null;
        String query = "SELECT currency_id,iso_code,currency_symbol"
                       +
    ...
    public boolean updateCurrency(com.magbel.admin.objects.CurrencyCode ccode) {
    ...
    public boolean updateExchangeRate(com.magbel.admin.objects.ExchangeRate ccode,
                                      boolean dirty) {
    ...
    public boolean logExchangeRate(String cid) {
        ...
        PreparedStatement ps = null;
        boolean done = false;
        com.magbel.admin.objects.ExchangeRate ccode = new com.magbel.admin.objects.ExchangeRate();
...
public boolean createExchangeRate(com.magbel.admin.objects.ExchangeRate ccode) {
 ...
 public boolean createCurrency(com.magbel.admin.objects.CurrencyCode ccode) {
