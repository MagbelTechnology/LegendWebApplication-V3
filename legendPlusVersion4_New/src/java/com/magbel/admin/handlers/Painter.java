...
public class Painter {
  ...
  public Painter(String title,String variables,Map data) {
...
System.out.println("===== StringBuffer sb ===="+sb);
  ...
  public static Map findDataByPriority(){
	  System.out.println("Inside findDataByPriority");
  	  StringBuffer sb = new StringBuffer();
  	  sb.append("select b.priority_description,count(a.priority) as total_incident ");
  	  sb.append(" from hd_complaint a,hd_priority b ");
  	  sb.append(" where a.priority = b.priority_code group by b.priority_description");
  	  System.out.println("===sb.toString()== "+sb.toString());
  	  return load(sb.toString());
  }

  public static Map findDataBySlaTech(){

	  StringBuffer sb = new StringBuffer();
	  sb.append("select b.user_name,count(a.incident_mode) as total_incident ");
	  sb.append(" from hd_complaint a,am_gb_user b ");
      sb.append(" where a.technician = b.user_id group by b.user_name ");
...
private static String ListToText(java.util.ArrayList a){
   ...
   private static String doText(String sql){
    	...
    	try{
    		 ...
    		 con =  new MagmaDBConnection().getConnection("helpDesk");
  ...
  private static Map load(String sql){
   ...
   private static java.sql.Connection getConnection()throws Exception{
	  ...
	  String url = "jdbc:sqlserver://127.0.0.1:1433;database=helpdesk";
