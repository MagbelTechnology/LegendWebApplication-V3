...
import com.magbel.admin.objects.PasswordHistory;
...
public class SecurityHandler {
    ...
    public java.util.List getAllPrivileges() {
        ...
        com.magbel.admin.objects.Privilege privilege = null;
        String query = "SELECT role_uuid,role_name,role_wurl" + " ,menu_type,priority" + "  FROM am_ad_privileges";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                privilege = new com.magbel.admin.objects.Privilege(role_uuid,
    ...
    public com.magbel.admin.objects.ClassPrivilege getClassPrivilege(
            String classid, String roleuuid) {
        com.magbel.admin.objects.ClassPrivilege classprivilege = null;

        String query = "SELECT clss_uuid,role_uuid,role_view,role_addn,role_edit" + " FROM am_ad_class_privileges" + " WHERE clss_uuid=? AND role_uuid=?";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                classprivilege = new com.magbel.admin.objects.ClassPrivilege(
    ...
    public boolean removeClassPrivilege(java.util.ArrayList list) {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        com.magbel.admin.objects.ClassPrivilege cp = null;
        int[] d = null;
        try {
            con = getConnection();
            ps = con.prepareStatement(query);
            for (int i = 0; i < list.size(); i++) {
                cp = (com.magbel.admin.objects.ClassPrivilege) list.get(i);
    ...
    public boolean insertClassPrivileges(java.util.ArrayList list) {
        String query = "INSERT INTO am_ad_class_privileges(clss_uuid,role_uuid" + " ,role_view,role_addn ,role_edit)" + " VALUES(?,?,?,?,?)";
        Connection con = null;
        PreparedStatement ps = null;
        com.magbel.admin.objects.ClassPrivilege cp = null;
        int[] d = null;
    ...
    public com.magbel.admin.objects.SecurityClass getSecurityClassById(String filter) {

        com.magbel.admin.objects.SecurityClass sc = null;
        String query = "SELECT class_id ,class_desc,class_name ,is_supervisor" + "  ,class_status,user_id,create_date,fleet_admin" + "  FROM am_gb_class WHERE  class_id=" + filter;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                sc = new com.magbel.admin.objects.SecurityClass(classId,
    ...
    public com.magbel.admin.objects.SecurityClass getSecurityClassByName(String filter) {

        com.magbel.admin.objects.SecurityClass sc = null;
        String query = "SELECT class_id ,class_desc,class_name ,is_supervisor" + "  ,class_status,user_id,create_date,fleet_admin" + "  FROM am_gb_class WHERE  class_name='" + filter + "'";
    ...
    public boolean updateSecurityClass(com.magbel.admin.objects.SecurityClass sc) {

        Connection con = null;
        PreparedStatement ps = null;
        boolean done = false;
        String query = "UPDATE am_gb_class SET class_desc = ?,class_name = ?" + "   ,is_supervisor = ?,class_status = ?" + "   ,fleet_admin = ?" + "   WHERE class_id = ?";
        ...
        try {
            ...
            ps.setString(3, sc.getIsSupervisor()== null? "":sc.getIsSupervisor());
            ps.setString(4, sc.getClassStatus());
            ps.setString(5, sc.getFleetAdmin() == null? "":sc.getFleetAdmin());
            ps.setString(6, sc.getClassId());
            done = (ps.executeUpdate() != -1);

        } catch (Exception e) {
            System.out.println(this.getClass().getName() + " ERROR:Error Updating Security Class ->" + e.getMessage());
        } finally {
            closeConnection(con, ps);
        }
        return done;
    ...
    public boolean createSecurityClass(com.magbel.admin.objects.SecurityClass sc) {

        Connection con = null;
        PreparedStatement ps = null;
        boolean done = false;
        String query = "INSERT INTO am_gb_class(class_desc,class_name,is_supervisor,class_status" + "    ,user_id,create_date ,fleet_admin,class_id)" + "    VALUES (?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            ps.setString(1, sc.getDescription());
            ps.setString(2, sc.getClassName());
            ps.setString(3, sc.getIsSupervisor() == null? "N":sc.getIsSupervisor() );
            ps.setString(4, sc.getClassStatus());
            ps.setString(5, sc.getUserId());
            ps.setDate(6, df.dateConvert(new java.util.Date()));
            ps.setString(7, sc.getFleetAdmin() == null? "N":sc.getFleetAdmin());
    ...
    public java.util.List getSecurityClassByQuery(String filter) {
        java.util.List _list = new java.util.ArrayList();
        com.magbel.admin.objects.SecurityClass sc = null;
        String query = "SELECT class_id ,class_desc,class_name ,is_supervisor" + "  ,class_status,user_id,create_date,fleet_admin" + "  FROM am_gb_class ";
    ...
    public boolean updateClassPrivilege(java.util.ArrayList list) {
        String query = "UPDATE am_ad_class_privileges SET " + "role_view = ?,role_addn = ?,role_edit = ?" + " WHERE clss_uuid=? AND role_uuid=?";
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        com.magbel.admin.objects.ClassPrivilege cp = null;
    ...
    public java.util.List getAllUsers() {
        ...
        String query = "SELECT User_Id, User_Name, Full_Name" + ", Legacy_Sys_Id, Class, Branch, Password" + ", Phone_No, is_Supervisor, Must_Change_Pwd" + ", Login_Status, User_Status, UserId, Create_Date" + ", Password_Expiry, Login_Date, Login_System, Fleet_Admin" + ", email, Branch,password_changed,Organization" + " FROM AM_GB_USER";
    ...
    public com.magbel.admin.objects.User getUserByUserID(String UserID) {
        com.magbel.admin.objects.User user = null;
        String expiryDate = "";
        String query = "SELECT User_Id, User_Name, Full_Name" + ", Legacy_Sys_Id, Class, Branch, Password" + ", Phone_No, is_Supervisor, Must_Change_Pwd" + ", Login_Status, User_Status, UserId, Create_Date" + ", Password_Expiry, Login_Date, Login_System, Fleet_Admin" + ", email, Branch,password_changed,branch_restriction, Expiry_Days,Expiry_Date,dept_code,Organization,Technician" + " FROM AM_GB_USER WHERE User_Id = '" + UserID + "'";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String deptCode = rs.getString("dept_code");
                System.out.println("======= getUserByUserID deptCode====== "+deptCode);
                String organization = rs.getString("Organization");
    ...
    public com.magbel.admin.objects.User getUserByUserName(String UserName) {
        com.magbel.admin.objects.User user = null;
        String query = "SELECT User_Id, Organization, User_Name, Full_Name" + ", Legacy_Sys_Id, Class, Branch, Password" + ", Phone_No, is_Supervisor, Must_Change_Pwd" + ", Login_Status, User_Status, UserId, Create_Date" + ", Password_Expiry, Login_Date, Login_System, Fleet_Admin" + ", email, Branch,password_changed" + " FROM AM_GB_USER WHERE User_Name = '" + UserName + "'";
    ...
    public boolean createUser(com.magbel.admin.objects.User user) {
        ...
        try {
            ...
            if (user.getExpiryDate() == "" || user.getExpiryDate().equalsIgnoreCase("null") || user.getExpiryDate() == null || user.getExpiryDate().equalsIgnoreCase("")) {
                ...
                query = "INSERT INTO AM_GB_USER( User_Name, Full_Name, Legacy_Sys_Id" + ", Class, Branch, Password, Phone_No, Is_Supervisor, Must_Change_Pwd" + ", Login_Status, User_Status, UserId, Create_Date, Password_Expiry" + ",Fleet_Admin, Email,User_id,branch_restriction, Expiry_Days,organization)VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                ...
                ps.setString(20, user.getorganization());

                done = (ps.executeUpdate() != -1);

            }//if
            else {
                query = "INSERT INTO AM_GB_USER( User_Name, Full_Name, Legacy_Sys_Id" + ", Class, Branch, Password, Phone_No, Is_Supervisor, Must_Change_Pwd" + ", Login_Status, User_Status, UserId, Create_Date, Password_Expiry" + ",Fleet_Admin, Email,User_id,branch_restriction, Expiry_Days,Expiry_Date,organization)VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                ...
                ps.setString(21, user.getorganization());
    ...
    public boolean updateUser(com.magbel.admin.objects.User user) {
        ...
        try {
            if (user.getExpiryDate() == "" || user.getExpiryDate().equalsIgnoreCase("null") || user.getExpiryDate().equalsIgnoreCase("")) {
                ...
                query = "UPDATE AM_GB_USER  SET  User_Name = ?, Full_Name = ?" + " ,Legacy_Sys_Id = ?, Class = ?, Branch = ?, Password = ?, Phone_No = ?" + ",Is_Supervisor = ?,Must_Change_Pwd = ?, Login_Status = ?, User_Status = ?" + ", Fleet_Admin = ?, Email = ?,branch_restriction =?, Expiry_Days =?, organization =?  " + " WHERE User_Id = ?";
                con = getConnection();
                ps = con.prepareStatement(query);
                ...
                ps.setString(17, user.getorganization());
                done = (ps.executeUpdate() != -1);


            } else {
                query = "UPDATE AM_GB_USER  SET  User_Name = ?, Full_Name = ?" + " ,Legacy_Sys_Id = ?, Class = ?, Branch = ?, Password = ?, Phone_No = ?" + ",Is_Supervisor = ?,Must_Change_Pwd = ?, Login_Status = ?, User_Status = ?" + ", Fleet_Admin = ?, Email = ?,branch_restriction =?, Expiry_Days =?, Expiry_Date=?, organization =? " + " WHERE User_Id = ?";
                con = getConnection();
                ps = con.prepareStatement(query);
                ...
                ps.setString(18, user.getorganization());
                done = (ps.executeUpdate() != -1);
            }//else
    ...
    public boolean confirmPassword(String iden, String pass) {
        ...
        String query = "SELECT PASSWORD FROM AM_GB_USER   " + "WHERE USER_ID = " + iden;
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        boolean done = false;
    ...
    public boolean updateLogins(String userid, String ipaddress) {
        ...
        String query = "UPDATE AM_GB_USER  SET LOGIN_STATUS= 1 ,LOGIN_SYSTEM='" + ipaddress + "'," + "login_date =?" + " WHERE   USER_ID = " + userid;
        Connection con = null;
        PreparedStatement ps = null;
        boolean done = false;
        try {
    ...
    public boolean updateLogins(String userid, String status, String ipaddress) {
        ...
        String query = "UPDATE AM_GB_USER  SET LOGIN_SYSTEM='" + ipaddress + "'," + "login_date = GetDate()" + " WHERE   USER_ID = " + userid;
        //String query = "UPDATE AM_GB_USER  SET LOGIN_STATUS= " + status + ",LOGIN_SYSTEM='" + ipaddress + "'," + "login_date = GetDate()" + " WHERE   USER_ID = " + userid;
        Connection con = null;
        PreparedStatement ps = null;
        boolean done = false;
        try {
    ...
    public boolean queryPexpiry(String userid) {
        String query = "SELECT password_expiry FROM AM_GB_USER   " + "WHERE USER_ID = " + userid;
    ...
    public String getBranchRestrictedUser(String userId) {
        ...
        String query = "SELECT branch_restriction " + " FROM AM_GB_USER WHERE User_Id = '" + userId + "'";
    ...
    public String getOrganName(String OrganId) {
        String OgranName = "";
       // System.out.print("+++++getOrganName+++++ ");
        String query = "SELECT ORG_NAME " + " FROM AM_AD_ORGANIZATION WHERE ORG_CODE = '" + OrganId + "'";
        ...
        try {
            ...
            rs = s.executeQuery(query);
            while (rs.next()) {
            	OgranName = rs.getString("AM_AD_ORGANIZATION");
            }
    ...
    public boolean updateExpiryDate(int user_id) {
        ...
        try {
            ...
            System.out.println("WARNING:Error updateExpiryDate() Query ->" + e.getMessage());
        } finally {
            closeConnection(con, ps);
        }
        return done;
    ...
    //modification lanre
    public boolean createManageUser(com.magbel.admin.objects.User user, String limit) {
        ...
        try {
            ...
            if (user.getExpiryDate() == "" || user.getExpiryDate().equalsIgnoreCase("null") || user.getExpiryDate() == null || user.getExpiryDate().equalsIgnoreCase("")) {
                ...
                query = "INSERT INTO AM_GB_USER( User_Name, Full_Name, Legacy_Sys_Id" + ", Class, Branch, Password, Phone_No, Is_Supervisor, Must_Change_Pwd" + ", Login_Status, User_Status, UserId, Create_Date, Password_Expiry" + ",Fleet_Admin, Email,User_id,branch_restriction, Expiry_Days,Approval_Limit)VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                ...
                query = "INSERT INTO AM_GB_USER( User_Name, Full_Name, Legacy_Sys_Id" + ", Class, Branch, Password, Phone_No, Is_Supervisor, Must_Change_Pwd" + ", Login_Status, User_Status, UserId, Create_Date, Password_Expiry" + ",Fleet_Admin, Email,User_id,branch_restriction, Expiry_Days,Expiry_Date,Approval_Limit,dept_code,organization)VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                ...
                ps.setString(23, user.getorganization());
                done = (ps.executeUpdate() != -1);
...
//insert into password history
    ...
    public boolean updateManageUser(com.magbel.admin.objects.User user, String limit) {
        ...
        try {
            if (user.getExpiryDate() == "" || user.getExpiryDate().equalsIgnoreCase("null") || user.getExpiryDate().equalsIgnoreCase("")) {
                ...
                query = "UPDATE AM_GB_USER  SET  User_Name = ?, Full_Name = ?" + " ,Legacy_Sys_Id = ?, Class = ?, Branch = ?, Password = ?, Phone_No = ?" + ",Is_Supervisor = ?,Must_Change_Pwd = ?, Login_Status = ?, User_Status = ?" + ", Fleet_Admin = ?, Email = ?,branch_restriction =?, Expiry_Days =?,Approval_Limit = ?,organization = ? WHERE User_Id = ?";
                con = getConnection();
                ps = con.prepareStatement(query);
                ...
                query = "UPDATE AM_GB_USER  SET  User_Name = ?, Full_Name = ?" + " ,Legacy_Sys_Id = ?, Class = ?, Branch = ?, Password = ?, Phone_No = ?" + ",Is_Supervisor = ?,Must_Change_Pwd = ?, Login_Status = ?, User_Status = ?" + ", Fleet_Admin = ?, Email = ?,branch_restriction =?, Expiry_Days =?, Expiry_Date=?,Approval_Limit = ?,dept_code=?,organization = ?  WHERE User_Id = ?";
                con = getConnection();
                ps = con.prepareStatement(query);
   ...
   //         System.out.println("===================logAuditTrailSecurityComp= within  compareAuditValues==============");
    ...
    public String getCompanyLoginAttempt() {
        ...
        try {
            ...
            con = getConnection();
            final String query = "select attempted_login from am_gb_company";
            ps = con.prepareStatement(query);
            //ps.setString(1, userName);
            res = ps.executeQuery();

            if (res.next()) {
                result = res.getString("attempted_login");
    ...
    public boolean updateManageUser(com.magbel.admin.objects.User user) {
    ...
    public java.util.ArrayList getUserByQuery(String filter, String Name, String pass) {
        ...
        String query = "SELECT User_Id,Organization, lower(User_Name) User_Name, Full_Name" + ", Legacy_Sys_Id, Class, Branch, Password" + ", Phone_No, is_Supervisor, Must_Change_Pwd"
                + ", Login_Status, User_Status, UserId, Create_Date" + ", Password_Expiry, Login_Date, Login_System, Fleet_Admin"
                + ", email, Branch, password_changed,Expiry_Date,branch_restriction" + ", approval_limit,approval_level,dept_code,section_code,is_helpdesk_manager " 
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (Name(userName, pass, cm.decrypt(password))) {
                    ...
                    String deptCode = rs.getString("dept_code");
                    String sectionCode = rs.getString("section_code");
                    String isHDManager = rs.getString("is_helpdesk_manager");
                    ...
                    user.setdeptCode(deptCode);
                    user.setSection(sectionCode);
                    user.setIsHelpdesk(isHDManager);
                    _list.add(user);
                }
            }
    ...
    public boolean updatePasswordHistory(PasswordHistory pass, String password) {
        ...
        try {
            ...
            if (pass.getCounter() == 1) {
                ...
                query = "UPDATE ad_password_history  SET  COUNTER = ?, PASSWORD = ?  ,CHANGEDATE = ? WHERE USERID = ?";
            }
    ...
    public boolean createPasswordHistory(String userid, String Password) {
        ...
        PreparedStatement ps = null;
        boolean done = false;
        String query = "INSERT INTO ad_password_history(USERID,COUNTER,PASSWORD)" + "    VALUES (?,?,?)";
        ...
        try {
            ...
            System.out.println(this.getClass().getName() + " ERROR:Error inserting ad_password_history  ->");
            e.printStackTrace();
        } finally {
            closeConnection(con, ps);
        }
    ...
    public boolean changePassword4(String userid, String password, String expiry, int limitCheck) {
        boolean result = false;
        boolean result2 = false;
        //fetch record from  ad password history based on userid
        java.util.ArrayList list = getAllPasswordHistory(userid);
...
// for reset password change
    ...
    //modification lanre
    public boolean createManageUser2(com.magbel.admin.objects.User user, String limit) {
        ...
        try {
            ...
            if (user.getExpiryDate() == "" || user.getExpiryDate().equalsIgnoreCase("null") || user.getExpiryDate() == null || user.getExpiryDate().equalsIgnoreCase("")) {
                ...
                query = "INSERT INTO AM_GB_USER( User_Name, Full_Name, Legacy_Sys_Id" + ", Class, Branch, Password, Phone_No, Is_Supervisor, Must_Change_Pwd" + ", Login_Status, User_Status, UserId, Create_Date, Password_Expiry" + ",Fleet_Admin, Email,User_id,is_helpdesk_manager, Expiry_Days,Approval_Limit,dept_code,Organization,Technician)VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                ...
                ps.setString(22, user.getorganization());
                ps.setString(23, user.getTechnician());
                ...
                query = "INSERT INTO AM_GB_USER( User_Name, Full_Name, Legacy_Sys_Id" + ", Class, Branch, Password, Phone_No, Is_Supervisor, Must_Change_Pwd" + ", Login_Status, User_Status, UserId, Create_Date, Password_Expiry" + ",Fleet_Admin, Email,User_id,branch_restriction, Expiry_Days,Expiry_Date,Approval_Limit,Organization,Technician)VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
//insert into password history
    ...
    public boolean updateManageUser2(com.magbel.admin.objects.User user, String limit) {
        ...
        try {
            if (user.getExpiryDate() == "" || user.getExpiryDate().equalsIgnoreCase("null") || user.getExpiryDate().equalsIgnoreCase("")) {
                ...
                query = "UPDATE AM_GB_USER  SET  User_Name = ?, Full_Name = ?" + " ,Legacy_Sys_Id = ?, Class = ?, Branch = ?, Password = ?, Phone_No = ?" + ",Is_Supervisor = ?,Must_Change_Pwd = ?, Login_Status = ?, User_Status = ?" + ", Fleet_Admin = ?, Email = ?,branch_restriction =?, Expiry_Days =?,Approval_Limit = ? ,dept_code=?, Organization=?, Technician=? WHERE User_Id = ?";
                ...
                ps.setString(12, user.getFleetAdmin());
                ps.setString(13, user.getEmail());
                String BranchRestrict = (user.getBranchRestrict() == null || user.getBranchRestrict().equals(""))?"N":user.getBranchRestrict();
                ps.setString(14, BranchRestrict);
                ps.setInt(15, user.getExpiryDays());
                ps.setString(16, limit); 
                ps.setString(17, user.getdeptCode());
              //  ps.setString(18, user.getUserId());
                ps.setString(18, user.getorganization());              
                String Technician = (user.getTechnician() == null || user.getTechnician().equals(""))?"N":user.getTechnician();
                ps.setString(19, Technician);
                ps.setString(20, user.getUserId());
                done = (ps.executeUpdate() != -1);


            } else {
                query = "UPDATE AM_GB_USER  SET  User_Name = ?, Full_Name = ?" + " ,Legacy_Sys_Id = ?, Class = ?, Branch = ?, Password = ?, Phone_No = ?" + ",Is_Supervisor = ?,Must_Change_Pwd = ?, Login_Status = ?, User_Status = ?" + ", Fleet_Admin = ?, Email = ?,branch_restriction =?, Expiry_Days =?, Expiry_Date=?,Approval_Limit = ?, Organization = ?, Technician =? " + " WHERE User_Id = ?";
                con = getConnection();
                ps = con.prepareStatement(query);
    ...
    public java.util.ArrayList getMailSetupQuery(String filter) {
        java.util.ArrayList _list = new java.util.ArrayList();
        com.magbel.admin.objects.User user = null;
        String query = "SELECT MAIL_FIELD_NAME, MAIL_FIELD_DESC FROM AM_GB_MAIL_FIELDS ";
        query += filter;
        Connection c = null;
        ResultSet rs = null;
        Statement s = null;
        ...
        try {
            ...
            rs = s.executeQuery(query);
            while (rs.next()) {
                String fullName = rs.getString("MAIL_FIELD_NAME");
                String userName = rs.getString("MAIL_FIELD_DESC");
                user = new com.magbel.admin.objects.User();
                user.setUserName(userName);
                user.setUserFullName(fullName);
                _list.add(user);
