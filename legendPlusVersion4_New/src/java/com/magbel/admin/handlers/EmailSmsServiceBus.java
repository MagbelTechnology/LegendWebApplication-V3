...
public void sendMailTransactionInitiator(int tran_id, String subject,String msgText1)
		{
			...
			try
			{
				...
				msg.setFrom(new InternetAddress(from));
				System.out.println("point 3");
				String to = app.userEmail(app.userToEmailTransInitiator(tran_id));
				InternetAddress[] address = { new InternetAddress(to) };
				System.out.println("point 4");
				msg.setRecipients(Message.RecipientType.TO,address);
...
{
    EmailSmsServiceBus embus = new EmailSmsServiceBus();
    embus.sendMail("ayojava@hotmail.com", "Ayojava", "This Is Fun");
}


public void sendMailHelpDesk(String senderEmail, String subject,String msgText1)
		{
