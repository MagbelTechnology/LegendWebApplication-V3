...
public class HtmlUtility12012011{

    public HtmlUtility12012011(){
    }
...
public void insToAm_Invoice_No(String assetID,String lpo,String invoiceNo,String TransType)
    {
        ...
        String query="Insert into Am_Invoice_no (asset_id,lpo,invoice_no,trans_type) values (?,?,?,?)";
...
htmlD = "<select name='"+opr+"'>"
 ...
 +"<option" +((opr != null) && opr.equals(selectChk)?" selected='true' " : "") +
   " value='<' = C > < </option> "*/ ;
    ...
    html1 = "<td><input name='"+fDate+id+"' type=text class=label id='"+fDate+id+"' > <input name='"+tDate+id+"' type=text class=label id='"+tDate+id+"' ></td>";
