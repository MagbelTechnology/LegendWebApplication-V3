...
public class newAssetTransaction
    implements Serializable
{
    ...
    private String land;
    private String wipLand;
    private String wipComputerSoftware;
    private String wipGenerators;
    private String wipGeneratorsHouse;
    private String wipMotorVehicles;
    private String wipOfficeEquipmentComputers;
    

   public newAssetTransaction()  
    {
          
    }

	public newAssetTransaction(String integrifyId,String description,String registrationNo,String vendorAC, String supplierName,
...
/*
    ...
    */
	...
	public String getWipLand() {
		return wipLand;
	}

	public void setWipLand(String wipLand) {
		this.wipLand = wipLand;
	} 

	public String getWipComputerSoftware() {
		return wipComputerSoftware;
	}

	public void setWipComputerSoftware(String wipComputerSoftware) {
		this.wipComputerSoftware = wipComputerSoftware;
	} 

	public String getWipGenerators() {
		return wipGenerators;
	}

	public void setWipGenerators(String wipGenerators) {
		this.wipGenerators = wipGenerators;
	} 

	public String getWipGeneratorsHouse() {
		return wipGeneratorsHouse;
	}

	public void setWipGeneratorsHouse(String wipGeneratorsHouse) {
		this.wipGeneratorsHouse = wipGeneratorsHouse;
	} 

	public String getWipMotorVehicles() {
		return wipMotorVehicles;
	}

	public void setWipMotorVehicles(String wipMotorVehicles) {
		this.wipMotorVehicles = wipMotorVehicles;
	} 

	public String getWipOfficeEquipmentComputers() {
		return wipOfficeEquipmentComputers;
	}

	public void setWipOfficeEquipmentComputers(String wipOfficeEquipmentComputers) {
		this.wipOfficeEquipmentComputers = wipOfficeEquipmentComputers;
	} 	
