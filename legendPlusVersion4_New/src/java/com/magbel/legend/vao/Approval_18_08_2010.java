...
public class Approval_18_08_2010 
{
	private String id;
	...
	public Approval_18_08_2010(String id, String description, String page, String flag, String partPay, String userId, String branch, String subjectToVat, String whTax, String operation1, String exitPage, String url) {
		super();
		this.id = id;
