 ...
 */
public class Report_18_03_2025 extends PersistenceServiceDAO {
...
//	          }
			 if(branch_Id.equals("0") && categoryCode.equals("0") && fromDate.equals("") && endDate.equals("")) {
				 System.out.println("No Selection in getAssetImprovementReportRecords: ");
			 }else{
				 if(!branch_Id.equals("0") && categoryCode.equals("0") && fromDate.equals("") && endDate.equals("")) {
					  s.setString(1, branch_Id);
					  s.setString(2, branch_Id);
...
public java.util.ArrayList getFixedAssetMovementScheduleRecords(String query,String FromDate, String ToDate)
{
	java.util.ArrayList _list = new java.util.ArrayList();
	String date = String.valueOf(dateConvert(new java.util.Date()));
	date = date.substring(0, 10);
...
//	Statement s = null;
	PreparedStatement s = null;
//	System.out.println("query in getFixedAssetMovementScheduleRecords: "+query+"  FromDate: "+FromDate+"  ToDate: "+ToDate);
	try {
		    c = getConnection();
			 s = c.prepareStatement(query.toString());
...
//        	  s.setString(1, endmonth);
//        	  s.setString(2, endyear);  
//        	  s.setString(3, endmonth);
//        	  s.setString(4, endyear);  
//        	  s.setString(5, endmonth);
//        	  s.setString(6, endyear);  
//        	  s.setString(7, endmonth);
//        	  s.setString(8, endyear);  
//        	  s.setString(9, endmonth);
//        	  s.setString(10, endyear);  
//        	  s.setString(11, endmonth);
//        	  s.setString(12, endyear);  
//        	  s.setString(13, endmonth);
//        	  s.setString(14, endyear);  
//        	  s.setString(15, endmonth);
//        	  s.setString(16, endyear);  
//        	  s.setString(17, endmonth);
//        	  s.setString(18, endyear);  
	          }
	          rs = s.executeQuery();  
			while (rs.next())
			   {			
				...
				String airCraft = rs.getString("AIRCRAFT");
				String computerSoftware = rs.getString("COMPUTER SOFTWARE");
				newAssetTransaction newTransaction = new newAssetTransaction();
