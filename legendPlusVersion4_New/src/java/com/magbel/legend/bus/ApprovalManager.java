...
public void infoFromApprovalOld(String assetId,String page) {
...
public void infoFromApproval(String assetId, String page) {
    ...
    String query = "select distinct(a.transaction_id),a.posting_date,a.tran_type,a.transaction_level,b.User_id,b.system_ip " +
                   "from am_asset_approval a, am_Raisentry_Transaction b where a.asset_id = b.asset_id and a.asset_id = ? and b.page1 = ?";
    ...
    try (Connection con = dbConnection.getConnection("legendPlus");
        ...
        try (PreparedStatement psInsert = con.prepareStatement(query1)) {
            psInsert.setString(1, assetId);
            psInsert.setInt(2, userId);
            psInsert.setDate(3, postDate);
            psInsert.setString(4, "Approved");
            psInsert.setInt(5, tranLevel + 1);
            psInsert.setDate(6, dbConnection.dateConvert(new java.util.Date()));
            psInsert.setString(7, systemIp);
            psInsert.setInt(8, tranId);
            psInsert.setString(9, tranType);
...
public void infoFromRejectionOld(int tranId,int userId,String systemIp,String rejectReason) {
...
public void infoFromRejection(int tranId, int userId, String systemIp, String rejectReason) {
    ...
    String query = "select posting_date,tran_type,transaction_level,asset_id " +
                   "from am_asset_approval where transaction_id=?";
    ...
    try (Connection con = dbConnection.getConnection("legendPlus");
        ...
        try (PreparedStatement psInsert = con.prepareStatement(query1)) {
            ...
            psInsert.setInt(2, userId);
            psInsert.setDate(3, postDate);
            psInsert.setString(4, "Rejected");
            psInsert.setInt(5, tranLevel + 1);
            psInsert.setTimestamp(6, dbConnection.getDateTime(new java.util.Date()));
            psInsert.setString(7, systemIp);
            psInsert.setInt(8, tranId);
            psInsert.setString(9, tranType);
            psInsert.setString(10, rejectReason);

            psInsert.execute();
        }

    } catch (Exception ex) {
        System.out.println("Error occurred in infoFromRejection --> ");
        ex.printStackTrace();
    }
}
...
try(Connection con = dbConnection.getConnection("legendPlus");
		PreparedStatement  ps = con.prepareStatement(getVendorTransactionQuery())) 
{
...
public boolean createApprovalRFIDTagListOld(String rfidtag,int Supervisor,String createDate,String description,String groupId,String scanstatus,String location) {
...
try(Connection con = getConnection();
	    PreparedStatement ps = con.prepareStatement(ins_am_asset_approval_qry)) 
{
	for(int j=0;j<No;j++){
...
public boolean AcceptRfidTagOld(String groupId, String rfidtag,String ReqnID,int recordNo) {
    boolean done = true;
...
public boolean RejectRfidTagTablesOld(String groupId, String rfidtag,String ReqnID,int recordNo) {
    boolean done = true;
...
public boolean MaterialUsedUpdateOld(String groupId, String rfidtag,String ReqnID,int recordNo) {
    boolean done = true;
...
public ArrayList findApprovalForUsedMaterialDByQueryOld(String filter) {
          RFID ar = null;
       ArrayList list = new ArrayList();
       String rfidTag = "";
       int mtid =0;
...
public ArrayList findApprovalForUsedMaterialDByQuery(String filter) {
    ...
    String query = "select MTID,RFID_TAG,LOCATION,SCANN_TYPE,SCANN_STATUS,USER_ID,CREATE_DATE,CREATE_DATETIME,REMARK,GROUP_ID,USED_BY,QUANTITY,QUANTITYBAL from ST_INVENTORY_RFID_APPROVED where MTID IS NOT NULL " + filter;
    ...
    try (Connection con = dbConnection.getConnection("legendPlus");
        ...
        System.out.println("Error occurred in findApprovalForUsedMaterialDByQuery --> ");
        ex.printStackTrace();
    }
...
public boolean RejectRfidTagforMaterialUsageOld(String groupId, String rfidtag,String ReqnID,int recordNo) {
    boolean done = true;
...
public boolean NewTagUsedOld(String rfidtag, String status) {
    boolean done = false;
    Connection con = null;
    PreparedStatement ps = null;
    String query = "";
...
public boolean createRFIDRecordInVerifyOld(String rfidTag, String location, String createDate, String createDateTime, int userId)
{
    Connection con;
...
public boolean createRFIDRecordInVerify(String rfidTag, String location, String createDate, String createDateTime, int userId) {
    ...
    try (Connection con = getConnection()) {
        ...
        try (PreparedStatement ps = con.prepareStatement(rfidquery)) {
            ps.setString(1, rfidTag);
            ps.setString(2, location);
            ps.setString(3, "I");
            ps.setString(4, "N");
...
public ArrayList groupStockApprovalOld(String compCode, String groupId,String assetId) {
       String barCode = "";
       String stockId ="";
       int userid = 0;
       String itemCode ="";
...
public ArrayList groupStockApproval(String compCode, String groupId, String assetId) {
    ...
    System.out.println("itemBalance in groupStockApproval: " + itemBalance);
    if (itemBalance == null || itemBalance == "") {
        itemBalance = "0";
    }
    System.out.println("itemBalance after in groupStockApproval: " + itemBalance);
...
public java.util.ArrayList groupStockApprovalNewOld(String compCode, String groupId)
 {
 	java.util.ArrayList list = new java.util.ArrayList();
...
public java.util.ArrayList groupStockApprovalNew(String compCode, String groupId) {
    ...
    try (Connection c = getConnection();
         ...
         ResultSet rs = s.executeQuery(notSignOutquery)) {
...
public boolean returnOfStockQuantity(String compCode, String inventCode, String warehouseCode,  int quantity,int branchId,String tag) {
    ...
    try(Connection con = dbConnection.getConnection("legendPlus");
    	    PreparedStatement ps = con.prepareStatement(returnquantity)) 
    {
        ps.setInt(1, quantity);
        ps.setString(2, tag);
        ps.execute();
...
public boolean approvalofNewRFIDTagListOld(String groupId,String Supervisor,String createDate,String userID,String description,String branchCode,String apprioveId,int level,String tranType) {
	//Timestamp CreateTime = dbConnection.getDateTime(new java.util.Date());
	//System.out.println("<<<<<<<<===Supervisor in createRFIDTagList: "+Supervisor+"    approvDate: "+createDate);
	//System.out.println("<<<<<<<<===groupId in approvalofRFIDTagList: "+groupId+"    userID: "+userID+"  description:"+description+"   branchCode: "+branchCode);
	    String ins_am_asset_approval_qry = "insert into am_asset_approval(asset_id,user_id,super_id,posting_date,description" +
...
public boolean MaterialUtilizationTransactionRecordOld(String compCode,String branchCode,String assetId,String rfidtag,String description,String warehouseCode,int quantity,String usedBy,int userId, int Quantitybalance) {
...
public boolean MaterialUtilizationTransactionRecord(String compCode, String branchCode, String assetId, String rfidtag, 
        String description, String warehouseCode, int quantity, 
        String usedBy, int userId, int Quantitybalance) {
...
public boolean deletedistributedRfidRecordforTransferOld(String rfidTag) {
  Connection con = null;
  PreparedStatement ps = null; 
...
public boolean deletedistributedRfidRecordforTransfer(String rfidTag) {
    ...
    try (Connection con = getConnection();
         ...
         PreparedStatement ps1 = con.prepareStatement(DELETE_QUERY2)) {
...
public String SupervisorApprovalListOld(String departCode,String userid,String userBranch) {
        String data = "";
        String delimeter = "#";
...
public boolean deleteMaterialUtilizeRfidRecordOld(String rfidTag) {
  Connection con = null;
  PreparedStatement ps = null;  
...
public boolean deletedistributedRfidRecordOld(String rfidTag) {
  Connection con = null;
  PreparedStatement ps = null;  
 // String DELETE_QUERY = "UPDATE ST_INVENTORY_RFID_UNUSED SET PROCESSED = 'P' WHERE RFID_TAG = '"+rfidTag+"' ";
  String DELETE_QUERY = "DELETE FROM ST_INVENTORY_RFID_UNUSED WHERE RFID_TAG = '"+rfidTag+"' ";
...
public boolean deletedistributedafterIssuanceRfidRecordOld(String rfidTag) {
	  Connection con = null;
	  PreparedStatement ps = null;  
	 // String DELETE_QUERY = "UPDATE ST_INVENTORY_RFID_UNUSED SET PROCESSED = 'P' WHERE RFID_TAG = '"+rfidTag+"' ";
...
public boolean NewTagUsedforSplitOld(String rfidtag, String status) {
    boolean done = false;
    Connection con = null;
    PreparedStatement ps = null;
    String query = "";
...
public String SupervisorMailAddressListOld(String batch_id) {
        String data = "";
        String delimeter = "#";
...
public boolean createApprovalRFIDTagListOld(String rfidtag,int Supervisor,String createDate,String description,String groupId,String scanstatus,String location,String branchId,String deptId) {
	createDate = String.valueOf(df.dateConvert(new java.util.Date()));
Timestamp CreateTime = dbConnection.getDateTime(new java.util.Date());
String usedBy = "";
int quantity = 0;
...
public boolean createApprovalRFIDTagList(String rfidtag, int Supervisor, String createDate, String description, 
        String groupId, String scanstatus, String location, 
...
public boolean insertHistoryTableOld(String compCode, String inventCode, String warehouseCode,  int quantity, int userid,String batchId,int prevBalance) {
...
public boolean insertHistoryTable(String compCode, String inventCode, String warehouseCode, int quantity, 
        int userid, String batchId, int prevBalance) {
...
public boolean updateStockQuantityforIssuanceOld(String AssetId, int quantity) {
    boolean done = true;
