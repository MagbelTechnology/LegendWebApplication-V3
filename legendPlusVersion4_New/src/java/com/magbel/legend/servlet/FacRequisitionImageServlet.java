 ...
 */
public class FacRequisitionImageServlet extends HttpServlet {
	 ...
	 */
	public FacRequisitionImageServlet() {
		super();
	...
	private void captureData(HttpServletRequest request)
	{
		...
		for (Part part : request.getParts()) {
		   ...
		   File fullfile = new File(part.getName());
			...
			System.out.println("there is an error in FacRequisitionImageServlet: captureData() method"	+ e);
		}
	}
