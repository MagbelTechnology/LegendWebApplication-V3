...
public class LicenseUploadExportServlet extends HttpServlet {
    /**
	 * 
	 */
...
//               out.println("Your home name is : " +home);
              ...
              String excelFilePath = "LICENSE RENEWAL UPLOAD";
//               out.println("Your excel file name is : " +excelFilePath);
             ...
             //  out.println("Your home 2 folder is : " + home2);
               String path = home2 +"/Downloads/"+"LICENSE RENEWAL UPLOAD.xls";
