...
public class LegacyGoupAssetCreationPost_21_11_2024 extends HttpServlet
{
...
//        String branchId = request.getParameter("branch_id");  
        ...
        System.out.println("<<<<<<groupid: "+groupid+"     MenuPage: "+MenuPage);
        ...
        System.out.println("<<<<<<branchId: "+branchId+"    Group Id: "+groupid+"     checker:"+checker);
...
//                  new MailSender().AttachmentMail("ayomidematanmi4@gmail.com",file);
            	...
            	if((appName.equalsIgnoreCase("FLEXICUBE-10.2.18"))){
                    ...
                    rowhead.createCell((int) 12).setCellValue("MAKER");
                    rowhead.createCell((int) 13).setCellValue("CHECKER");
                    int i = 1;
...
//                       System.out.println("value of fullPath is " + fullPath);
 ...
 //              		System.out.println("Writing row Iterator ");
               		//closing the Stream  
               	//	fileOut.close();  
...
//               		 response.sendRedirect("DocumentHelp.jsp?np=legacyExporter&s=n");
 ...
 //                   System.out.println("About to Close csv File");
         ...
         //         workbook.write(stream);
           //       stream.close();
                  System.out.println("Data is saved in CSV file.");
        		    ...
        		    out.print("<script>alert('The file has been Droped into the specified Locationn on the server');</script>");
