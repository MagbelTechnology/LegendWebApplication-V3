...
public class FleetMaintanaceExport extends HttpServlet
{
...
//    System.out.println("<<<<<<branch_Id: "+branch_Id);
    ...
    String fileName = "";
    if(reportType.equalsIgnoreCase("D")){fileName = branchCode+"By"+userName+"FleetMaintenanceDetailReport.xls";}
    if(reportType.equalsIgnoreCase("S")){fileName = branchCode+"By"+userName+"FleetMaintenanceSummaryReport.xls";}
...
//    	 System.out.println("======>>>>>>>Details Selected asset_Id: "+asset_Id+"    FromDate: "+FromDate+"   ToDate: "+ToDate);	     
	     ColQuery ="select b.Asset_Id,REGISTRATION_NO,a.DESCRIPTION,a.Cost_Price,repaired_date,Vendor_Name,a.details,component_replaced,"
	 + "last_Pm_Date, next_Pm_Date,c.CREATE_DATE,b.transaction_date "
	 + "from FT_MAINTENANCE_DETAILS a,am_Raisentry_Transaction b,FT_MAINTENANCE_HISTORY c, am_ad_vendor v  "
	 + "where a.HIST_ID = c.HIST_ID and CONVERT(varchar, c.LT_ID) = CONVERT(varchar, b.TRANS_ID) "
	 + "and TECHNICIAN_NAME = v.Vendor_Id and b.page1 = 'FLEET MAINTENANCE RAISE ENTRY' and b.ISO = '000' " 
...
//	   System.out.println("======>>>>>>>reportType Selected: "+branch_Id+"   categoryCode: "+categoryCode+"    FromDate: "+FromDate+"   ToDate: "+ToDate+"  dept_Code: "+dept_Code+"   asset_Id: "+asset_Id);
     ColQuery ="select b.Asset_Id,REGISTRATION_NO,details AS DESCRIPTION,a.Cost_Price,repaired_date,Vendor_Name,a.details,component_replaced,last_Pm_Date, "
     + "next_Pm_Date,a.CREATE_DATE,b.transaction_date "
     + "from FT_MAINTENANCE_HISTORY a,am_Raisentry_Transaction b, am_ad_vendor v "
	 + "where CONVERT(varchar, a.LT_ID) = CONVERT(varchar, b.TRANS_ID) and TECHNICIAN_NAME = v.Vendor_Id "
	 + "and b.page1 = 'FLEET MAINTENANCE RAISE ENTRY' and b.ISO = '000' "
	 + "and transaction_date between ? and ? "
	 + "ORDER BY b.ASSET_ID, REPAIRED_DATE,TRANSACTION_DATE "; 
    	 }
    	 if(!asset_Id.equals("")  && !FromDate.equals("")  && !ToDate.equals("")){	
...
//   System.out.println("======>>>>>>>ColQuery: "+ColQuery);
     java.util.ArrayList list =rep.getFleetMaintenanceRecords(ColQuery,FromDate,ToDate,asset_Id);
