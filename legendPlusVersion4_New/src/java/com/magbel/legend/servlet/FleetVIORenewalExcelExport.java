...
public class FleetVIORenewalExcelExport extends HttpServlet
{
...
//    OutputStream out = null;
    ...
    "attachment; filename=AssetFleetVIORenewal.xls");
...
//			String amount = records.getCodeName("select VENDOR_CODE from FLEET_SUMINSURED where ASSET_ID = '"+assetId+"'");
//			String vendorCode = records.getCodeName("select SUM_INSURED from AM_AD_INSURANCE where ASSET_ID = '"+assetId+"' and TRAN_TYPE = 'V'");
//			String effectiveDate = records.getCodeName("select EFFECTIVE_DATE from FLEET_SUMINSURED where ASSET_ID = '"+assetId+"' and TRAN_TYPE = 'V'");
 //           HSSFRow row = sheet.createRow((short) i);
           ...
           s.addCell(new Label(7, i, amount));
