...
//   		records.updateAssetWithBatchId(tableName, columnName,  whereFld,  groupid, status);
        String qb = "update a set a.asset_status = 'ACTIVE' FROM am_asset a,am_asset_approval g, am_raisentry_post p where a.Asset_id = g.Asset_id and convert(varchar,a.Asset_id) = convert(varchar,p.Id) and process_status = 'A' and entryPostFlag = 'N' and GroupIdStatus = 'N' and page = 'ASSET CREATION RAISE ENTRY' and a.POSTING_BATCH ='"+groupid+"' ";
        ad.updateAssetStatusChange(qb);	
   		 posttable = "am_asset_approval";
   		 String tableName2 = "am_raisentry_post";
  		 status1 = "A";
  		 status2 = "ACTIVE";
  		 String page = "ASSET CREATION RAISE ENTRY";
   		records.updateAssetApprovalWithBatchId(tableName, posttable,tableName2, groupid, status1, status2); 	
   	   	tableName = "am_asset";   			
        ...
        boolean done = records.insertRaiseEntryTransaction(groupid,page,userId);
   		...
   		if(tableName.equals("am_group_asset")){
   	   		...
   	   		whereFld = "POSTING_BATCH";
//   	   		records.updateAssetWithBatchId(tableName, columnName,  whereFld,  groupid, status);
   	        String qa = "update g set g.Asset_Status = 'ACTIVE' FROM am_asset a, am_group_asset g, am_asset_approval p, am_raisentry_post r where a.Asset_id = g.Asset_id and a.GROUP_ID = p.asset_id and convert(varchar,a.Group_id) = convert(varchar,r.Id) and process_status = 'A' and entryPostFlag = 'N' and GroupIdStatus = 'N' and tran_type = 'Group Asset Creation' and POSTING_BATCH='"+groupid+"' ";
   	        ad.updateAssetStatusChange(qa);	
   	        String qb = "update a set a.asset_status = 'ACTIVE' FROM am_asset a, am_group_asset g, am_asset_approval p, am_raisentry_post r where a.Asset_id = g.Asset_id and a.GROUP_ID = p.asset_id and convert(varchar,a.Group_id) = convert(varchar,r.Id) and process_status = 'A' and entryPostFlag = 'N' and GroupIdStatus = 'N' and tran_type = 'Group Asset Creation' and g.POSTING_BATCH ='"+groupid+"' ";
   	        ad.updateAssetStatusChange(qb);
	        String qap = "update a SET a.process_status = 'A',a.asset_status = 'ACTIVE' am_asset_approval a, am_group_asset g, am_raisentry_post p where CONVERT(VARCHAR, a.asset_id) = CONVERT(VARCHAR, g.group_Id) and convert(varchar,a.asset_Id) = convert(varchar,p.Id) and a.process_status = 'A' and entryPostFlag = 'N' and GroupIdStatus = 'N' and tran_type = 'Group Asset Creation' and POSTING_BATCH = '"+groupid+"'";
...
//  		records.updatePostWithBatchId(tableName, posttable, groupid, status1, status2);
        ...
        ad.updateAssetStatusChange(qa);	   	   	
   		...
   		String tableName2 = "am_asset_approval";
   		String page = "ASSET IMPROVEMENT RAISE ENTRY";
//   		records.updateImprovementWithBatchId(tableName, tableName2, posttable, groupid);
   	    String query_a ="UPDATE a SET a.Cost_Price  = a.Cost_Price+b.cost_increase,a.nbv = a.nbv+b.cost_increase, a.Monthly_Dep = 0.00,a.TOTAL_NBV = a.TOTAL_NBV+b.cost_increase,a.Vatable_Cost = a.Vatable_Cost+b.vatable_cost "
   	    		+ "from  "+tableName+" a, "+posttable+" b, "+tableName2+" p where a.Asset_id = b.Asset_id and CONVERT(VARCHAR, b.Revalue_ID) = p.batch_id and b.IMPROV_USEFULLIFE = 0 and IMPROVED = 'Y' and p.process_status = 'A' and b.POSTING_BATCH = '"+groupid+"' " ;
//   	 System.out.println("query_a: "+query_a);
      	 ad.updateAssetStatusChange(query_a);
   	    String query_b ="update a set a.IMPROV_COST = coalesce(a.IMPROV_COST,0) + b.cost_increase, a.IMPROV_NBV = coalesce(a.IMPROV_NBV,0) + b.cost_increase, a.TOTAL_NBV = coalesce(a.TOTAL_NBV,0) + b.cost_increase, "
   	    		...
   	    		+ "from  "+tableName+" a, "+posttable+" b, "+tableName2+" p where a.Asset_id = b.Asset_id and CONVERT(VARCHAR, b.Revalue_ID) = p.batch_id and b.IMPROV_USEFULLIFE > 0 and APPROVAL_STATUS = 'ACTIVE' and IMPROVED = 'Y' and p.process_status = 'A' and b.POSTING_BATCH = '"+groupid+"' " ;
//   	    System.out.println("query_b: "+query_b);
   	     ad.updateAssetStatusChange(query_b);   		
//   		System.out.println("updatePostWithBatchId 5");
        String qaprove = "update a SET a.approval_status = 'POSTED',a.STATUS = 'IMPROVED', IMPROVED = 'Y' from am_asset_improvement a, am_asset_approval g where CONVERT(VARCHAR, a.asset_id) = CONVERT(VARCHAR, g.asset_id) and CONVERT(VARCHAR,a.Revalue_ID) = g.batch_id and g.process_status = 'A' and APPROVAL_STATUS = 'ACTIVE' and IMPROVED = 'Y' and a.approval_status != 'REJECTED' and POSTING_BATCH = '"+groupid+"'";
//        System.out.println("qaprove: "+qaprove);
        ...
        if(tableName.equals("AM_GROUP_IMPROVEMENT")){
   		...
   		status1 = "Y";
   		status2 = "Y";
//   		System.out.println("updatePostWithBatchId 3");
   	   	records.updatePostWithBatchId(tableName, posttable, groupid,status1,status2);
//   	 System.out.println("updatePostWithBatchId 4");
...
//   		System.out.println("AM_GROUP_IMPROVEMENT 2");     
   		...
   		whereFld = "POSTING_BATCH";
   		records.updatePostWithBatchId(tableName, columnName1, columnName2, columnName3,  whereFld, groupid, status1, status2, status3);
   	 String query_r ="update a set a.IMPROVED = 'Y', a.APPROVAL_STATUS='POSTED' from am_asset_improvement_Upload a, AM_GROUP_IMPROVEMENT b where a.Revalue_ID = b.Revalue_ID and a.asset_id = b.asset_id and b.POSTING_BATCH = '"+groupid+"' ";
	    ad.updateAssetStatusChange(query_r);
...
//   		records.updateImprovementWithBatchId(tableName,tableName2, posttable, groupid);
   	    String query_Upload_a ="UPDATE a SET a.Cost_Price  = a.Cost_Price+b.cost_increase,a.nbv = a.nbv+b.cost_increase, a.Monthly_Dep = 0.00,a.TOTAL_NBV = a.TOTAL_NBV+b.cost_increase,a.Vatable_Cost = a.Vatable_Cost+b.vatable_cost "
   	    		+ "from  "+tableName+" a, "+posttable+" b where a.Asset_id = b.Asset_id and b.IMPROV_USEFULLIFE = 0 and IMPROVED = 'P' and b.POSTING_BATCH = '"+groupid+"' " ;
   	    ad.updateAssetStatusChange(query_Upload_a);
   	    String query_Upload_b ="update a set a.IMPROV_COST = coalesce(a.IMPROV_COST,0) + b.cost_increase, a.IMPROV_NBV = coalesce(a.IMPROV_NBV,0) + b.cost_increase, a.TOTAL_NBV = coalesce(a.TOTAL_NBV,0) + b.cost_increase, "
   	    		+ "a.IMPROV_VATABLECOST = coalesce(a.IMPROV_VATABLECOST,0) + a.Vatable_Cost, IMPROV_MONTHLYDEP = 0.00, IMPROV_REMAINLIFE = coalesce(IMPROV_REMAINLIFE,0) + b.IMPROV_USEFULLIFE, a.IMPROV_TOTALLIFE = coalesce(a.IMPROV_TOTALLIFE,0) + b.IMPROV_USEFULLIFE "
   	    		+ "from  "+tableName+" a, "+posttable+" b where a.Asset_id = b.Asset_id and b.IMPROV_USEFULLIFE > 0  and IMPROVED = 'P' and b.POSTING_BATCH = '"+groupid+"' " ;
   	    ad.updateAssetStatusChange(query_Upload_b);   		
...
//      		records.updatePostWithBatchId(tableName, posttable, groupid, status1, status2);
	        String qc = "update a SET a.Asset_Status = 'DISPOSED',a.Date_Disposed = '"+transDate+"' from AM_ASSET a, am_assetdisposal g where CONVERT(VARCHAR, a.Asset_id) = CONVERT(VARCHAR, g.asset_id) and g.POSTING_BATCH = '"+groupid+"'";
...
//      		System.out.println("AM_GROUP_DISPOSAL 3");
     		...
     		String page = "ASSET DISPOSAL RAISE ENTRY";
//      		records.updatePostWithBatchId(tableName, posttable, groupid, status1, status2);
	        String qgd = "update a SET a.Asset_Status = 'DISPOSED',a.Date_Disposed = '"+transDate+"' from AM_ASSET a, AM_GROUP_DISPOSAL g where CONVERT(VARCHAR, a.Asset_id) = CONVERT(VARCHAR, g.asset_id) and g.POSTING_BATCH = '"+groupid+"'";
...
//  Taken to Depreciation      	   records.updatePostingRecordScript("UPDATE a SET a.Asset_id  = b.new_asset_id,a.OLD_ASSET_ID = b.Asset_id, a.Category_ID = b.new_category_id,a.CATEGORY_CODE = c.category_code, "
...
//          		ad.updateAssetStatusChange(query_cat);
          		String query_oldcat ="update a set old_depr_rate = c.Dep_rate from am_assetReclassification a, am_ad_category c where a.old_category_id = c.category_ID and a.POSTING_BATCH = '"+groupid+"' ";
          		ad.updateAssetStatusChange(query_oldcat);
          		String query_newcat ="update a set new_depr_rate = c.Dep_rate from am_assetReclassification a, am_ad_category c where a.new_category_id = c.category_ID and a.POSTING_BATCH = '"+groupid+"' ";
          		ad.updateAssetStatusChange(query_newcat);
...
//           	 	System.out.println("am_assetReclassification 6");
           ...
           if(tableName.equals("am_assetUpdate")){
        	   status3 = "ACTIVE";
//        	  String test =  "UPDATE a SET a.Asset_Status  = b.Asset_Status "
