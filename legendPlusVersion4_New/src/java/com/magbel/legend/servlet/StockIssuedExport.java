...
public class StockIssuedExport extends HttpServlet
{
	/**
	 * 
	 */
...
//    OutputStream out = null;
        ...
        String branch_Code = request.getParameter("issuedBySolId");
        System.out.println("<<<<<<branch_Code: "+branch_Code);
        String userName = request.getParameter("userName");
        String fileName = branch_Code+"By"+userName+"DepreciationChargesExport.xls";
        String filePath = System.getProperty("user.home")+"\\Downloads";
        File tmpDir = new File(filePath);
        boolean exists = tmpDir.exists();
        ArrayList[] listOldNew = new ArrayList[2];
/*	if(exists==true){
...
//    if(exists==false){
            ...
            BulkStockUpdateManager bulkupdateMan = new BulkStockUpdateManager();
...
//            java.util.ArrayList list =rep.getDepreciationChargesExportRecords(ColQuery);
           listOldNew =bulkupdateMan.findStockIssuanceDisplayByBatchId(String.valueOf(tranId));
           List list = new ArrayList(Arrays.asList(listOldNew)); 
           if(list.size()!=0){
