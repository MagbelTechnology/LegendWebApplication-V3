...
public class BulkAssetProofSectionExport_21112019 extends HttpServlet
{
...
//    OutputStream out = null;
 ...
 //   	ad = new AssetRecordsBean();
     ...
     String fileName = branch_Id+"By"+userName+"AssetDownLoadForverification.xls";
  ...
  //   String fileName = branch_Id+"AssetProof.xls";
     ...
     if(branch_Id!=null){ColQuery ="SELECT *FROM "+tableName+"";}
     else{ColQuery ="SELECT *FROM "+tableName+"";}
     java.util.ArrayList list =rep.getBulkAssetProofSqlRecords(ColQuery);
     System.out.println("<<<<<<ColQuery: "+ColQuery+"     list.size(): "+list.size());
 ...
 //           HSSFRow row = sheet.createRow((short) i);
     ...
     w.write();
     w.close();
     String q = "DROP TABLE "+prooftranId+"";
