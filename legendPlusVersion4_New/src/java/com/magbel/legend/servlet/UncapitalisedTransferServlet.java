...
public class UncapitalisedTransferServlet extends HttpServlet
{
     ...
     
   {
	   try {
		...
		//	 System.out.println("We are here: ");
		 ...
		 // System.out.println("assetCode: " + assetCode);
		  ...
		  magma.asset.dto.Uncapitalized asset = (magma.asset.dto.Uncapitalized)assetMan.getAsset(id);
		...
		//  System.out.println("newDept: " + newDept);
		  int newSec = Integer.parseInt(request.getParameter("newSection")== "" || request.getParameter("newSection") == null ? "0" : request.getParameter("newSection"));
		  System.out.println("newSec: " + newSec);
		  String newWhoToRem1 = request.getParameter("newWhoToRem1");
		//  System.out.println("newWhoToRem1: " + newWhoToRem1);
		  String newWhoToRem2 = request.getParameter("newWhoToRem2");
		//  System.out.println("newWhoToRem2: " + newWhoToRem2);
		  String newEmail1 = request.getParameter("newEmail1");
		//  System.out.println("newEmail1: " + newEmail1);
		  String newEmail2 = request.getParameter("newEmail2");
		//  System.out.println("newEmail2: " + newEmail2);
		...
		//  System.out.println("tran_status: " + tran_status);
		  ...
		  String categoryCode = aprecords.getCodeName("SELECT  category_code from AM_ASSET_UNCAPITALIZED where asset_id = '" + id+"'");
		  ...
		  int oldCategoryId = request.getParameter("oldCategoryId") == null?0:Integer.parseInt(request.getParameter("oldCategoryId")); 
		  ...
		  String[] pa = new String[12];
		   ...
		   pa[6]= effDate; 
		   pa[8]="ACTIVE"; 
		   pa[9]="Uncapitalised Asset Transfer"; 
		   pa[10]="P"; 
		   pa[11]=cost;
		...
		*/
		...
		categoryCode = aprecords.getCodeName("SELECT  old_category_code from am_UncapitalizedTransfer where asset_id = '" + id+"'");
		...
		newWhoToRem2,newEmail2,effDate,mtid,categoryCode,description,Double.parseDouble(cost),nbv,monthDep,accumDep,assetCode);


		String change_id_query2 = "update AM_ASSET_UNCAPITALIZED set asset_id ='"+newAsset_id+"' where old_asset_id ='"+id+"'";
		ad.updateAssetStatusChange(change_id_query2);
		...
		String change_id_query2 = "update AM_ASSET_UNCAPITALIZED set old_asset_id ='"+id+"', asset_id ='"+newAsset_id+"' where asset_id ='"+id+"'";
		ad.updateAssetStatusChange(change_id_query2);
		}


		String revalue_query = "update am_UncapitalizedTransfer set approval_Status='ACTIVE', new_asset_id='"+newAsset_id+"' where transfer_id = '"+mtid+"'";
		ad.updateAssetStatusChange(revalue_query);
...
//				String url = "DocumentHelp.jsp?np=assetTransfersRaiseEntry&id=" + newAsset_id + "&operation=0&exitPage=DocumentHelp.jsp?np=manageUncapitalTransfers&pageDirect=Y";
...
//			  	aprecords.insertApprovalx(newAsset_id, description, page1, flag, partPay,asset_User_Name,branchName,subject_to_vat,wh_tax,url,assetCode);
		...
		out.print("<script> window.location='DocumentHelp.jsp?np=manageUncapitalTransfers'</script>");
		 }
		...
		//ad.updateAssetStatusChange(revalue_query);
			...
			String revalue_query = "update am_UncapitalizedTransfer set approval_Status='PENDING' where transfer_id = '"+mtid+"'";
		ad.updateAssetStatusChange(revalue_query);
		...
		String otherparam = "UncapitalisedTransfers_Approval&operation=1&id="+id+"&tranId="+approvaltransId+"&transaction_level=1&approval_level_count=0&assetCode="+assetCode;				
...
//					System.out.println("SupervisorId#$$$$$$$$$$$ "+supervisorId);
			  		 ad.setPendingTransMultiApp(pa,"6",assetCode,supervisorId,mtid);
