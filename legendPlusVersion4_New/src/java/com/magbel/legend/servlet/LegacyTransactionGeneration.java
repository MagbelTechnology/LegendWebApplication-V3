...
//	System.out.println("<<<<<<We are here: "); 
    try 
    {
    	...
    	String legacySystemId = records.getCodeName("select Legacy_Sys_id from am_gb_user where User_Id = ? ",userId);
    	
    	 java.util.ArrayList list =comp.getLegacyTransactionRecords(start_Date,end_Date,BankingApp,legacySystemId);   
...
//				System.out.println("makerId: "+ makerId + " serialNo: " + serialNo + " checkerId: " + checkerId + " transDescription: " + transDescription +  " batchNo: " + batchNo
//						+ " accountNo: " + accountNo + " amount: " + amount + " tranType: " + tranType + " branchCode: " + branchCode + " postingDate: " + postingDate + " BankingApp: "
//						+ BankingApp);
...
//	     }
     ...
     out.println("alert('Total No (" + list.size() + ") Of Records From Legacy System.');");
