...
public class ProcessCreateEMSVendor extends HttpServlet
{
...
//        String [] idSplit = id.split("/");         
        String test1 = "select category_name from am_ad_category where Asset_Ledger = '"+vendordebitAccount+"' ";
        String test2 = "select category_name from am_ad_category where ACCUM_DEP_LEDGER = '"+vendordebitAccount+"'";
        String test3 = "select category_name from am_ad_category where DEP_LEDGER = '"+vendordebitAccount+"' ";
...
//        System.out.println("==========aquisitiondebitAcctName: "+aquisitiondebitAcctName);  
        ...
        String test20 = "select category_name from am_ad_category where Asset_Ledger = '"+vendorcreditAccount+"' ";
        String test21 = "select category_name from am_ad_category where ACCUM_DEP_LEDGER = '"+vendorcreditAccount+"' ";
        String test22 = "select category_name from am_ad_category where DEP_LEDGER = '"+vendorcreditAccount+"' ";
...
//        System.out.println("==========vendorAcctName: "+vendorAcctName+"    vendoramount: "+vendoramount);
        if(vendorAcctName==""){vendorAcctName = "No Account Found";}
        try
        {        
