     ...
     if(branch_Id.equals("0")  && categoryCode.equals("0") && FromDate.equals("") && ToDate.equals("")){
  	   System.out.println("======>>>>>>>No Selection: "+branch_Id+"   categoryCode: "+categoryCode+"    FromDate: "+FromDate+"   ToDate: "+ToDate);
  	     ColQuery ="SELECT\n"
  	     		...
  	     		+ "convert(varchar(50),am_assetTransfer.cost_price) AS am_assetTransfer_cost_price,\n"
  	     		+ "convert(varchar(50),am_assetTransfer.Accum_Dep) AS am_assetTransfer_Accum_Dep,\n"
  	     		+ "convert(varchar(50),am_assetTransfer.Monthly_Dep) AS am_assetTransfer_Monthly_Dep,\n"
