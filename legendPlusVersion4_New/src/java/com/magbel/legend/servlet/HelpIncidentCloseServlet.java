...
public class HelpIncidentCloseServlet extends HttpServlet {
    ...
    public HelpIncidentCloseServlet() {
        super();
    }
    ...
    private void processRequisition(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("=====returnPage before in HelpIncidentCloseServlet === "+returnPage+"  =====returncode === "+returncode);
        ComplaintResponse complaintResponse = new ComplaintResponse();
        if (returnPage == null) { returnPage = "DocumentHelp.jsp?";}else{returnPage = "DocumentHelp.jsp?np="+returnPage+"&query=null";}
        System.out.println("=====returnPage After in HelpIncidentCloseServlet === "+returnPage);
        ...
        if (operation != null && operation.equalsIgnoreCase("Save")) {
          ...
          //      doneSave = true;          
                 ...
                 if (returncode != null && returncode.equalsIgnoreCase("ID")) { 
                 System.out.println("====returncode 1=== "+returncode); 
                     out.print("<script>window.location='DocumentHelp.jsp?np=DocumentHelp'</script>");
