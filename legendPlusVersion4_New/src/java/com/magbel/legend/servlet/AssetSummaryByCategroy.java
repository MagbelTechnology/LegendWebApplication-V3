...
public class AssetSummaryByCategroy extends HttpServlet
{
...
//    OutputStream out = null; 
    ...
    String fileName = branch_Code+"By"+userName+"AssetManagementReport.xls";    	
...
+ " ORDER BY a.BRANCH_CODE ASC,a.CATEGORY_CODE ASC ";
   ...
   if(branch_Id.equals("***")  && categoryCode.equals("***")){
	   System.out.println("======>>>>>>>No Selection: ");
	     ColQuery ="SELECT *FROM AssetMgtSummaryCategory "
	 + "WHERE am_Asset_Asset_Id IS NOT NULL "
...
//   System.out.println("======>>>>>>>ColQuery: "+ColQuery);
     ...
     if(list.size()!=0){
         ...
         rowhead.createCell((short) 2).setCellValue("CODE");
         rowhead.createCell((short) 3).setCellValue("TOTAL");
         rowhead.createCell((short) 4).setCellValue("TOTAL COST");
		 ...
		 rowhead.createCell((short) 8).setCellValue("IMPROV TOTAL COST");
		 rowhead.createCell((short) 9).setCellValue("IMPROVE ACCUM");
		 rowhead.createCell((short) 10).setCellValue("IMPROVE MONTHLY");
		 rowhead.createCell((short) 11).setCellValue("IMPROVE NBV");
		 rowhead.createCell((short) 12).setCellValue("FINAL TOTAL COST");
		 rowhead.createCell((short) 13).setCellValue("FINAL TOTAL ACCUM");
		 rowhead.createCell((short) 14).setCellValue("FINAL TOTAL NBV");
...
//			System.out.println("======>newAccumDepr: "+newAccumDepr);
            ...
            row.createCell((short) 2).setCellValue(deptName);
            row.createCell((short) 3).setCellValue(sbucode);
            row.createCell((short) 4).setCellValue(purchaseDate);
