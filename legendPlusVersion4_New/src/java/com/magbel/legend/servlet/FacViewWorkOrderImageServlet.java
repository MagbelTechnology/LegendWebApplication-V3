 ...
 */
public class FacViewWorkOrderImageServlet extends HttpServlet {
	 ...
	 */
	public FacViewWorkOrderImageServlet() {
		super();
	...
	private void viewRequisitionImage(HttpServletRequest request,HttpServletResponse response) 
	{
       ...
       // System.out.println("about to load class");
        ...
        image = getGroupImageData(workOrderCode,pageName,compCode);
	...
	private byte[] getGroupImageData(String workOrderCode, String pageName,String compCode)
	{
		byte[] fileBytes=null;
		mgDbCon = new MagmaDBConnection();
		String retrieveReqnImageQry="select image from FM_Requisition_Image where ReqnID='"+workOrderCode+"'";
