...
public class FacMgtWorkCompletionAcceptanceRepost extends HttpServlet {
    ...
    public FacMgtWorkCompletionAcceptanceRepost() {
        super();
    }
    ...
    private void processRequisition(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (Integer.parseInt(noOfWorkDes)<1) {
            ...
            out.print("<script>window.location='DocumentHelp.jsp?np=facilityMgtWorkCompletionFormRepost&" +
                    "ReqnID=" + reqnID + "&assetId="+assetId+"&tranId=" + tranId + "'</script>");
        } else {
           ...
           String deleteFromCompletedWork = " delete from FM_COMPLETED_WORK where WORK_ORDER_CODE='"+workOrderCode+"'";
           ...
           // String acceptanceReceiveMeans = request.getParameter("acceptanceReceiveMeans");
            ...
            try {
                if (outcome[1] != -1) {
                    ...
                    //to delete previous completed work
                    ...
                    pstmt.setInt(13, Integer.parseInt(tranId));
                   ...
                   // pstmt.setInt(17, numberOfWorkDescriptions);
                    ...
                    if (!done)//successful
                    {
                       ...
                       // GenerateList genList = new GenerateList();
                        ...
                        //to delete previous transaction for work completion
                    ...
                    out.print("<script>window.location='DocumentHelp.jsp?np=facilityMgtWorkCompletionFormUpdateRepost&" +
