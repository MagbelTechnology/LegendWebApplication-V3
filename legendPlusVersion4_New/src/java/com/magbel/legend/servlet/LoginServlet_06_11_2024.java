...
public class LoginServlet_06_11_2024 extends HttpServlet {
...
//							System.out.print("User Id for Token Users: " + Token_UserId);
				...
				//			    System.out.print("Token====: " + token);						
							...
							session.setAttribute("FAILED_LOGON_CTN", "1");
							//out.print("alert('Invalid User Name/Password details. Try Again.')");
							//out.println("<script>window.location = 'systemConnect.jsp'</script>");
							out.print("Invalid User Name/Password details. Try Again.");
...
//										out.println("<script>window.location = 'systemConnect.jsp'</script>");
										out.print("You have exceded logon limits. Contact Administrator.");
									}
