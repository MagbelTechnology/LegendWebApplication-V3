...
public class AssetConsolidateRegisterReport extends HttpServlet
{
...
//    String userName = request.getParameter("userName");
    String fileName = "";
    if(report.equalsIgnoreCase("rptMenuBConsolid")){fileName = branchCode+"By"+userName+"AssetRegisterConsolidationReport.xlsx";}
...
//   System.out.println("======>>>>>>>ColQuery: "+ColQuery);
     ...
     if(list.size()!=0){
   	 if(report.equalsIgnoreCase("rptMenuBConsolid")){
		 ...
		 rowhead.createCell( 28).setCellValue("Registration No.");
...
//			String categoryName = records.getCodeName("select BRANCH_NAME from am_ad_branch where BRANCH_ID = "+branchId+"");
			...
			String oldAssetId = newassettrans.getOldassetId();
			String registrationNo = newassettrans.getRegistrationNo().equals(null) ? "" :newassettrans.getRegistrationNo();
			...
			Row row = sheet.createRow((int) i);
			 ...
			 rowhead.createCell( 29).setCellValue("Registration No.");
			...
			row.createCell((short) 29).setCellValue(registrationNo);
