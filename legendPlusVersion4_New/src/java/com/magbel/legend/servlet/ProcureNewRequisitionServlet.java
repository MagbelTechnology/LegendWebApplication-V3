...
public class ProcureNewRequisitionServlet extends HttpServlet {
    ...
    public ProcureNewRequisitionServlet() {
        super();
    }
    ...
    private void processRequisition(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (reqnID != null && !reqnID.equalsIgnoreCase("null") && operation != null && operation.equalsIgnoreCase("update")) {
            ...
            try {
                ...
                System.out.println("error occurred in ProcedureNewRequisitionServlet>>> " + ex);
            }
        ...
        if (reqnID != null && !reqnID.equalsIgnoreCase("null") && operation != null && operation.equalsIgnoreCase("save")) {
            ...
            try {
                ...
                System.out.println("Error occurred when save procurement requisition :" + e);
            }
        ...
        if (operation != null && (operation.equalsIgnoreCase("add"))) {
        	 ...
        	 String updateRecTeablePR = " update PR_REQUISITION  set status ='REJECTED' where ReqnID='" + reqnID + "'";
        	genList.updateTable(updateRecTeablePR);
