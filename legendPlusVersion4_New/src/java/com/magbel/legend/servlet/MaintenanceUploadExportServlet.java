...
public class MaintenanceUploadExportServlet extends HttpServlet {
    /**
	 * 
	 */
...
//            out.println("Your home name is : " +home);
          ...
          String newLocation = location+"\\legendPlus\\sample\\";
           String excelFilePath = "MAINTENANCE RENEWAL UPLOAD";
//            out.println("Your excel file name is : " +excelFilePath);
            ...
            String path = home2 +"/Downloads/"+"MAINTENANCE RENEWAL UPLOAD.xls";
