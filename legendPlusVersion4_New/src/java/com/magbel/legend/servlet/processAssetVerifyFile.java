...
import magma.net.manager.AssetVrifyUploadManager;
...
public class processAssetVerifyFile extends HttpServlet {
	...
	if(!locationPath.exists()) {
  	...
  	Part part = request.getPart("file");
          ...
          //   File savedFile = new File(home + "\\Downloads",part.getSubmittedFileName());
             ...
             AssetVrifyUploadManager excelManager = new AssetVrifyUploadManager(uid,groupid);
  		//it.write(savedFile);
  		...
  		{ 
  			...
  			out.print("<script>location.replace('DocumentHelp.jsp?np=uploadAssetListVerifyDetail&gid="+groupid+"');</script>");
  			...
  			session.setAttribute("PATH",payFile);
  				...
  				out.println("<script type=\"text/javascript\">");
				   ...
				   out.println("location='DocumentHelp.jsp?np=VerificationListUpload';");
				   out.println("</script>");
  			}
  	/*
  	out.print("<script>");
