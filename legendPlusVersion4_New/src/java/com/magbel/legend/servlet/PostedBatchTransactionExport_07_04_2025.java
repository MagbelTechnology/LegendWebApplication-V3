...
public class PostedBatchTransactionExport_07_04_2025 extends HttpServlet
{
...
//			String branchName = records.getCodeName("select BRANCH_NAME from am_ad_branch where BRANCH_ID = "+branchId+"");
                    ...
                    String AccountName = records.getCodeName("select VENDOR_NAME from am_ad_vendor where Vendor_Code = ? ",branchCode);
