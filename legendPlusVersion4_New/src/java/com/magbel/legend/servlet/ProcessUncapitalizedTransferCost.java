...
public class ProcessUncapitalizedTransferCost extends HttpServlet
{
    ...
    public ProcessUncapitalizedTransferCost()
    {
    }
 ...
 try  
    {
	 ...
	 System.out.println(" <<<<<<<<<<<<<************************************>>>>>>>>>>>>> ");
         String newAssetId = records.getCodeName("select new_asset_id from am_UncapitalizedTransfer where asset_id='" + id + "'");
