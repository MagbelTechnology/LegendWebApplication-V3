...
public class LegacyGoupUncapCreationPost extends HttpServlet
{
	   ...
	   String groupPost = request.getParameter("groupPost");
        ...
        if (BatchApiUrl != null && !BatchApiUrl.trim().isEmpty()) {
		    ...
		    try {
		        ...
		        // ✅ ONLY reaches here if batchNo is valid
...
//                System.out.println("======>>>>>>>ColQuery=======: "+ColQuery);
            ...
            if(MenuPage.equals("groupAssetUploadBranchPostingSummary")){  
         ...
         //         workbook.write(stream);
           //       stream.close();
                  ...
                  if(uploadResponse == true) {
                     ...
                     // out.println((new StringBuilder("<script> window.location ='DocumentHelp.jsp?np="+MenuPage+"&P=Y&id="+id+"&tranType="+tranType+"&legacy_status=Y'</script>"))); 
