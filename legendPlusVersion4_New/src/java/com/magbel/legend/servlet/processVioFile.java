...
public class processVioFile extends HttpServlet {
   private static final long serialVersionUID = 1L;

   protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      System.out.println("Calling Process Vio File");
  	String payFile = "";
  	String dname = "";
  	int quantity = 1;
...
//             System.out.println("Trimed file to be saved to the disk is "+savedFile);
		...
		if(transType.equals("I") || transType.equals("V")){out.print("<script>location.replace('DocumentHelp.jsp?np=Fleet_VIOUpdate&recType="+recType+"');</script>");}
		else{out.print("<script>location.replace('DocumentHelp.jsp?np=FleeVIOUploadDetail');</script>");}
