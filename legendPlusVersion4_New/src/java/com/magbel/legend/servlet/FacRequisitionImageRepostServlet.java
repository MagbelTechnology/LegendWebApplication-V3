 ...
 */
public class FacRequisitionImageRepostServlet extends HttpServlet {
	 ...
	 */
	public FacRequisitionImageRepostServlet() {
		super();
			 ...
			 if(output==true)
		        {
				 ...
				 String upd_IA_requisition_qry="update FM_Requisition set image='Y' where reqnID='"+reqnId+"'";
