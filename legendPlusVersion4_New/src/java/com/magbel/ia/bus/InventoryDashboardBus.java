...
public class InventoryDashboardBus extends PersistenceServiceDAO {
    ...
    public ArrayList findAllWareHouseByQuery(String filter2,String filter) 
	{
        ...
        public boolean isWareHouseExisting(String id) 
		{
            ...
            public boolean createItemType(String itemTypeCode,String companyCode,String name,int userId,String inventory,String costMethod,String status,String categoryCode) 
			{  
                    String CREATE_QUERY = "INSERT INTO ST_ITEMTYPE "
                                    + "(ITEMTYPE_CODE,COMP_CODE,NAME,MTID,USERID,IS_INVENTORY,COST_METHOD,status,CATEGORY_CODE) " + "VALUES(?,?,?,?,?,?,?,?,?)";
                    Connection con = null;
                    PreparedStatement ps = null;
                ...
                auotoGenCode = itemTypeCode;
                    try {
                           ...
                           ps.setString(9,categoryCode);
                            ...
                            System.out.println("Error creating ItemType... ->"
                                            + er.getMessage());
                    } finally {
                            closeConnection(con, ps);
                    }
            ...
            public boolean updateItemType(String name, String itemTypeCode,String inventory,String costMethod,String status, String categoryCode) 
			{
                    String UPDATE_QUERY = "UPDATE  ST_ITEMTYPE "
                                    + "SET STATUS=?,NAME=?,IS_INVENTORY=?,COST_METHOD=?, CATEGORY_CODE = ? " + " WHERE ITEMTYPE_CODE = ?";
                    Connection con = null;
                    PreparedStatement ps = null;
                    boolean done = false;
                    try {
			...
			{
                    ArrayList records = new ArrayList();
                    String SELECT_QUERY = "SELECT MTID, ITEMTYPE_CODE,NAME,USERID,IS_INVENTORY,COST_METHOD,status,CATEGORY_CODE"
                                    + " FROM ST_ITEMTYPE";
                    Connection con = null;
                    PreparedStatement ps = null;
                    ResultSet rs = null;
    ...
    public ArrayList findAllItemTypeByQuery(String filter2,String filter) 
	{
            ...
            public ItemType findItemTypeById(String id) 
			{
                    ...
                    String FIND_QUERY = "SELECT MTID,ITEMTYPE_CODE,NAME,USERID,IS_INVENTORY,COST_METHOD,status,CATEGORY_CODE  "
...
*/
        ...
        public boolean createInventoryItem(String ItemNo, String Status, String Type, 
                ...
                double adjustMaxAmtLimit,String companyCode,String receivable)
				{ //passed
                 ...
                 String isAutoGen = getCodeName("SELECT auto_generate_ID FROM AM_GB_COMPANY");
                        ...
                        String CREATE_QUERY = "INSERT INTO  ST_INVENTORY_ITEMS( "+
                                              ...
                                              "max_amt_limit,adjust_acct,adj_Max_Approve_Level,adj_min_amt_limit,adj_max_amt_limit,comp_Code,receivable) "+
                                              "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                        Connection con = null;
                        PreparedStatement ps = null;
                        boolean done = false;
               ...
               public boolean updateInventoryItem(String ItemNo, String Status, String Type, String Description, String TaxCode, int MinimumQuantity, 
                              ...
                              String adjustAcct,int adjustMaxApproveLevel,double adjustMinAmtLimit,double adjustMaxAmtLimit,String receivable)
				{//passed
                        ...
                        String UPDATE_QUERY = "UPDATE ST_INVENTORY_ITEMS "+
                                              ...
                                              "ADJ_MAX_AMT_LIMIT=?,receivable=? WHERE item_code = ? ";
                        Connection con = null;
                        PreparedStatement ps = null;
                        boolean done = false;
...
/*                            
                            ...
                            System.out.println("WeightAvgCost >>>>>>>>>>>>>>>>>>>> " + WeightAvgCost);
                            System.out.println("StandardCost >>>>>>>>>>>>>>>>>>>> " + StandardCost);
                            System.out.println("FIFO >>>>>>>>>>>>>>>>>>>> " + FIFO);
                            System.out.println("Weight >>>>>>>>>>>>>>>>>>>> " + Weight);
                            System.out.println("BackOrderable >>>>>>>>>>>>>>>>>>>> " + BackOrderable);
                            System.out.println("reorderLevel >>>>>>>>>>>>>>>>>>>> " + reorderLevel);
                            System.out.println("salesAcct >>>>>>>>>>>>>>>>>>>> " + salesAcct);
                            System.out.println("COGSoldAcct >>>>>>>>>>>>>>>>>>>> " + COGSoldAcct);
                            System.out.println("inventoryAcct >>>>>>>>>>>>>>>>>>>> " + inventoryAcct);
                            System.out.println("reqApproval >>>>>>>>>>>>>>>>>>>> " + reqApproval);
                            System.out.println("maxApproveLevel >>>>>>>>>>>>>>>>>>>> " + maxApproveLevel);
                            System.out.println("minAmtLimit >>>>>>>>>>>>>>>>>>>> " + minAmtLimit);
                            System.out.println("maxAmtLimit >>>>>>>>>>>>>>>>>>>> " + maxAmtLimit);
                            System.out.println("adjustAcct >>>>>>>>>>>>>>>>>>>> " + adjustAcct);
                            System.out.println("adjustMaxApproveLevel >>>>>>>>>>>>>>>>>>>> " + adjustMaxApproveLevel);
                            System.out.println("adjustMinAmtLimit >>>>>>>>>>>>>>>>>>>> " + adjustMinAmtLimit);
                            System.out.println("adjustMaxAmtLimit >>>>>>>>>>>>>>>>>>>> " + adjustMaxAmtLimit);
                                 ...
                                 while(rs.next())
                                   {
                                         ...
                                         InventoryItem invItem = new InventoryItem(mtid, itemno, status, type, description, taxcode, minqty, 
                                                                        ...
                                                                        minAmtLimit,maxAmtLimit,adjustAcct,adjustMaxApproveLevel,adjustMinAmtLimit,adjustMaxAmtLimit,fifo,receivable);
                                         records.add(invItem);
                                         }
                        }catch(Exception er){
        ...
        */
        ...
        public void updateInventoryTotals(String mtId, String itemCode, int itemBalance, String desc, String
         ...
         public ArrayList findAllInventoryTotalByQuery(String filter2,String filter){
                        ...
                        String SELECT_QUERY = "SELECT DISTINCT a.item_code,a.balance,a.warehouse_code,a.userid,a.balance_ltd," +
