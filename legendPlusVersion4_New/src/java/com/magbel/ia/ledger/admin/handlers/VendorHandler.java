...
public class VendorHandler { 
    ...
    public boolean requireAccttype()  {
     ...
     public boolean accountValidOld(String accountNumber)
     {
    	...
    	boolean flag = false;
        String query = "select oldacct from acctmap where oldacct = '"+accountNumber+"' ";
        ResultSet rs = null;
	PreparedStatement ps = null;
     ...
     public String accountValidNew(String accountNumber)  
     {
    	...
    	try{
    		con = getConnectionOracle();
    		stmt = con.createStatement();
    	rs = stmt.executeQuery("select newacct from acctmap where newacct = '"+accountNumber+"' ");
         while (rs.next())
	{
    ...
    private Connection getConnectionOracle() {
      ...
      public String accountNew(String accountNumber)
     {
        ...
        String account  = "Invalid";
        String query = "select newacct from acctmap where oldacct='"+accountNumber+"' ";
        ResultSet rs = null;
	PreparedStatement ps = null;
        con = getConnectionOracle();
       ...
       public String AccountCheck(String acctNo)
			 {
			       String accountNumber = "" ;
					String query = " SELECT FORACID FROM GAM  WHERE FORACID = '"+acctNo+"' ";
					Connection c = null;
					ResultSet rs = null;
					PreparedStatement ps = null;
				try {
