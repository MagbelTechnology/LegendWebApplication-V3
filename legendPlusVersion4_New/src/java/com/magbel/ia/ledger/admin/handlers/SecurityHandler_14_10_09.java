 ...
 */
public class SecurityHandler_14_10_09 {
	...
	public SecurityHandler_14_10_09() {
    ...
    String expiryDate= "";
		String query = "SELECT User_Id, User_Name, Full_Name"
				...
				+ ", Login_Status, User_Status, UserId, Create_Date"
				+ ", Password_Expiry, Login_Date, Login_System, Fleet_Admin"
				+ ", email, Branch,password_changed,branch_restriction, Expiry_Days,Expiry_Date, branch_posting_restriction" + " FROM AM_GB_USER WHERE User_Id = '"
				+ UserID + "'";
