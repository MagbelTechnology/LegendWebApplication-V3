...
public  String getGeneratedId(String tableName) {
   ...
   public  String getGeneratePVC(String branchid) {
//		 System.out.println("getGeneratedId branchid: "+branchid);
		 	dateFormat = new DatetimeFormat();
		     sdf = new SimpleDateFormat("dd-MM-yyyy");

		     int counter = 0;
		 	final String FINDER_QUERY = "SELECT PETTY_VOUCHER + 1 FROM MG_AD_Branch "+
		 							    "WHERE BRANCH_CODE = '"+branchid+"'";
		 	final String UPDATE_QUERY = "UPDATE MG_AD_Branch SET PETTY_VOUCHER = PETTY_VOUCHER + 1 "+
		 								"WHERE BRANCH_CODE = '"+branchid+"'";
		 	String id = "";
//		 	System.out.println("getGeneratedId FINDER_QUERY: "+FINDER_QUERY);
		 	...
		 	try{
		 		...
		 		System.out.println("WARN:Error generating Payment Vouvher Number for Payment:"+
		 				branchid+"\n"+ex);
		 	}finally{
		 		closeConnection(con,ps,rs);
		 	}
   ...
   public  String getGenerateReceiptNo(String branchid) {
	 //System.out.println("getGeneratedId tableName: "+tableName);
	 	dateFormat = new DatetimeFormat();
	     sdf = new SimpleDateFormat("dd-MM-yyyy");

	     int counter = 0;
	 	final String FINDER_QUERY = "SELECT RECEIPT_NO + 1 FROM MG_AD_Branch "+
	 							    "WHERE BRANCH_CODE = '"+branchid+"'";
	 	final String UPDATE_QUERY = "UPDATE MG_AD_Branch SET RECEIPT_NO = RECEIPT_NO + 1 "+
	 								"WHERE BRANCH_CODE = '"+branchid+"'";
	 	String id = "";
	 //	System.out.println("getGeneratedId FINDER_QUERY: "+FINDER_QUERY);
	 	Connection con = null;
