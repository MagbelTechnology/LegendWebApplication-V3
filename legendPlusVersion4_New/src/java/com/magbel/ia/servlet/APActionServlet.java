...
public class APActionServlet extends HttpServlet {
                    ...
                    /*    if(pymtCode.equals("")||pymtCode == null){
                            ...
                            if(serviceBus.isRecordExisting("SELECT COUNT(PAYMENT_CODE) FROM IA_SALES_PAYMENTS WHERE PAYMENT_CODE = '"+pymtCode+"' AND SORDER_CODE='"+orderCode+"'")){
                                ...
                                if(serviceBus.createPurchasePayment(orderCode,chequeNo,bankCode,amountOwing,amountPaid,userId,pymtType,accountNo,
                                                                    ...
                                                                    drAmount,effDate,crAcctNo,crAcctType,crTranCode,crNarration,crAmount,companyCode)){
                              ...
                              /* if(pymtCode.equals("")||pymtCode == null){
                                   ...
                                   if(serviceBus.isRecordExisting("SELECT COUNT(PAYMENT_CODE) FROM IA_SALES_PAYMENTS WHERE PAYMENT_CODE = '"+pymtCode+"' AND SORDER_CODE='"+orderCode+"'")){
                                       ...
                                       if(serviceBus.createPurchasePayment(orderCode,chequeNo,bankCode,amountOwing,amountPaid,userId,pymtType,
                                                                      ...
                                                                      drNarration,drAmount,effDate,crAcctNo,crAcctType,crTranCode,crNarration,crAmount,companyCode)){
                                           pymtCode = serviceBus.pymtCode;
                                           out.print("<script>alert('Record Succesfully Saved.')</script>");
                                           out.print("<script>window.document.location='DocumentHelp.jsp?np="+pymtPg+"&orderCode="+orderCode+"&pymtCode="+pymtCode+"'</script>");
                             ...
                             /*  if(pymtCode.equals("")||pymtCode == null){
                                   ...
                                   if(serviceBus.isRecordExisting("SELECT COUNT(PAYMENT_CODE) FROM IA_SALES_PAYMENTS WHERE PAYMENT_CODE = '"+pymtCode+"' AND SORDER_CODE='"+orderCode+"'")){
                                       ...
                                       if(serviceBus.createPurchasePayment(orderCode,chequeNo,bankCode,amountOwing,amountPaid,userId,pymtType,accountNo,
                                                                 ...
                                                                 effDate,crAcctNo,crAcctType,crTranCode,crNarration,crAmount,companyCode)){
                                           pymtCode = serviceBus.pymtCode;
                                           out.print("<script>alert('Record Succesfully Saved.')</script>");
                                           out.print("<script>window.document.location='DocumentHelp.jsp?np="+pymtPg+"&orderCode="+orderCode+"&pymtCode="+pymtCode+"'</script>");
