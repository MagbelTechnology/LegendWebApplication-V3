...
public class InvoiceVoucherServlet extends HttpServlet
{
 ...
 //       strUnitPrice = strUnitPrice.replaceAll(",", "");
    ...
    //    String invoiceNo = request.getParameter("invoiceNo");
        ...
        String accountNo = request.getParameter("ledgerNo");
        String Bank = request.getParameter("Bank");
        String chequeNo = request.getParameter("chequeNo");
        String term = request.getParameter("term");
        String ledgerNo = request.getParameter("acctno");
      ...
      //  String invoiceNo = branchCode;
       ...
       // System.out.println("BranchAcronym====> "+BranchAcronym);
        ...
        try
        {
            if(id == null)
            {
                ...
                out.print("<script>window.location='DocumentHelp.jsp?np=newVoucherInvoiceDetails&id="+mid+"&invoiceNo="+invoiceNo+"&customerCode="+customerCode+"'</script>");
       //         out.println("<html><b><font color ='red'>No Transactions to Export to CSV!</font></b><br><a href ='DocumentHelp.jsp?np=ExportToCSVTrunc&CHECK_TYPE="+cType+"&clr_session="+clrSession+"&valueDate="+clearDate+"&ZONE_TYPE="+Zone+"'>Back</html>");
            } else
            {
                ...
                out.print("<script>window.location='DocumentHelp.jsp?np=newVoucherInvoiceDetails&customerCode="+customerCode+"'</script>");
            }
        }
