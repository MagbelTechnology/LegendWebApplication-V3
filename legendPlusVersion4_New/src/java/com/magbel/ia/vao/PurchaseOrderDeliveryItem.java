...
public class PurchaseOrderDeliveryItem {
    ...
    public PurchaseOrderDeliveryItem(String id,String orderCode,int quantity,
    double unitPrice,double amount,double advancePymt,String itemCode,int quantDeliver,
    int quantRemain,String batchCode,String transDate,int userId,String vendorCode) {
