...
public class PurchaseOrderItem {
 ...
 private double advancePymtPerc;
 private double discount;
 private double discountPerc;
    public PurchaseOrderItem(String id,String orderCode,int quantity,
    double unitPrice,double amount,double advancePymt,String itemCode,int quantDeliver,int quantRemain,
    double advancePymtPerc,double discount,double discountPerc) {
    ...
    setAdvancePymtPerc(advancePymtPerc);
    ...
    public void setAdvancePymtPerc(double advancePymtPerc) {
        this.advancePymtPerc = advancePymtPerc;
    }

    public double getAdvancePymtPerc() {
        return advancePymtPerc;
    }
