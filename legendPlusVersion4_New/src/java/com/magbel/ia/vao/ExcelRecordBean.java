...
import com.magbel.util.ConnectionClass;
...
public class ExcelRecordBean extends ConnectionClass
{
...
//    System.out.println("=====createGroupUpload description=====> "+description);
    ...
    "ASSET_STATUS,SBU_CODE,ASSET_CODE,ASSET_USER)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
