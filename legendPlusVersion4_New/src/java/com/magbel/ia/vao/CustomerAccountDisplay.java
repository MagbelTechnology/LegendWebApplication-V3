...
public class CustomerAccountDisplay implements Serializable 
{
	...
	private  String  mtId;
	  ...
	  private  double  yTD  = 0.00d;
		...
		private  double  witholdingAmount = 0.00d;
	    private  double  vat  = 0.00d;
...
public final void setWitholdingAmount(double   WitholdingAmount) {
	this.witholdingAmount =   WitholdingAmount;
}
