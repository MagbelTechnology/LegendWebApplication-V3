...
//			System.out.println("supervisorName >>>>>> "+supervisorName);
			...
			String test = "select full_name from am_gb_user where user_name = '"+UserName+"' AND USER_STATUS = 'ACTIVE'";
//			System.out.println("test >>>>>> "+test);
			if((!UserName.equalsIgnoreCase("")) && (!UserName.equalsIgnoreCase(null))){user_confirm = comp.findObject("select full_name from am_gb_user where user_name = '"+UserName+"' AND USER_STATUS = 'ACTIVE'");}
			if((!UserName.equalsIgnoreCase("")) && (!UserName.equalsIgnoreCase(null))){UserID = comp.findObject("select USER_ID from am_gb_user where user_name = '"+UserName+"' AND USER_STATUS = 'ACTIVE'");}
