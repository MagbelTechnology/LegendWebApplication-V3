 ...
 */
public class CompanyHandlerWitNewImprovement {
	Connection con = null;
	...
	public CompanyHandlerWithNewImprovement() {
...
public java.util.ArrayList getNewAssetSqlRecords()
{
	...
	String finacleTransId= null;
		String query = " SELECT INTEGRIFY_ID,Description,Registration_No,Vendor_AC,Date_purchased,Asset_Make,Asset_Model," +
				...
				"ASSET_CODE,ERROR_MESSAGE,ASSET_TYPE,Wh_Tax_Value,QUANTITY,TRAN_TYPE,Location,Spare_1,Spare_2,Multiple,Memo,MemoValue,IMPROV_USEFULLIFE from NEW_ASSET_INTERFACE WHERE POSTED = 'N' ";
...
//    System.out.println("Whholding Tax Rate: "+whtaxvalue+"  assetCode: "+assetCode);
   ...
   // return done;
    ...
    public int insertAssetMaintananceNoSupervisor(double cost, double nbv, String assetId,
                 ...
                 double newVatAmt,double newWhtAmt,double newVatableCost,double newNbv, String integrifyId,int usefullife) {
...
//    		System.out.println("About to set query for usefullife not equal Zero ");
            ...
            "IMPROV_NBV = coalesce(IMPROV_NBV,0)+?, IMPROV_VATABLECOST = coalesce(IMPROV_VATABLECOST,0) + ?, VAT = VAT+ ?, WH_TAX_AMOUNT = WH_TAX_AMOUNT+?, IMPROV_ACCUMDEP = coalesce(IMPROV_ACCUMDEP,0)+?, "+
     ...
     "R_VENDOR_ID,OLD_VENDOR_ACC,OLD_VENDOR_ID,DESCRIPTION,CATEGORY_CODE,BRANCH_CODE,lpoNum,invoice_no,"+
      "new_cost_price,asset_code,NEW_VATABLE_COST,NEW_NBV,NEW_VAT_AMOUNT,NEW_WHT_AMOUNT,INTEGRIFY,IMPROV_USEFULLIFE,IMPROVED)"+
     " VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
//          System.out.println("updateQuery1: "+updateQuery1);
         ps1.setDouble(1, cost);
         ps1.setDouble(2, cost);
         ps1.setDouble(3, cost);
         ps1.setDouble(4, vatableCost);
         ps1.setDouble(5, vatAmt);
         ps1.setDouble(6, whtAmt);
         ps1.setDouble(7, accumDep);
         ps1.setString(8, wh_tax);
         ps1.setInt(9, wht_percent);
         ps1.setString(10, subject_to_vat);
         ps1.setInt(11, Integer.parseInt(vendorId));
         ps1.setString(12, vendorAcct);
         ps1.setInt(13, usefullife);
         ps1.setInt(14, usefullife);
         ps1.setString(15, effDate);
         ps1.setString(16, effDate);
         ps1.setString(17, assetId);
            i = ps1.executeUpdate();  
          }*/
     } catch (Exception e) {
     String warning = "WARNING:Error inserting am_asset_improvement Revaluation And Am_Asset->" +
            e.getMessage();
     System.out.println(warning);
     e.printStackTrace();
     } finally {
    ...
    public int insertAssetMaintanance(double cost, double nbv, String assetId,
                 ...
                 String vendorAccOld, String description,String categoryCode,String branchCode,String lpo,String invoiceNum,int assetCode,String integrify,int usefullife) {
...
//	System.out.println("effDate: "+effDate);  
   ...
   //  costPrice += cost;
    ...
    // String updateQuery = "UPDATE AM_ASSET SET COST_PRICE = COST_PRICE + ?," +
     ...
     "R_VENDOR_ID,OLD_VENDOR_ACC,OLD_VENDOR_ID,DESCRIPTION,CATEGORY_CODE,BRANCH_CODE,lpoNum,invoice_no,INTEGRIFY,asset_code,IMPROV_USEFULLIFE,IMPROVED)"+
     " VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
