...
//System.out.println("----IN findSolutionWorkInProgressQry--- filterQry--- "+filterQry);
    ...
    public ArrayList findImageattached(String complaintId) {
        ...
        String rmarkQry = "select ID,File_Name,sessionId from AM_AD_IMAGE where ID='" + complaintId + "' order by sessionId";
...
//                "HD_COMPLAINT " + filterQry;
      ...
      // System.out.println("===== findProcurmentWorkInProgressQryTechnician rmarkQry===== "+rmarkQry);
...
String rmarkQry = "select id,Announce_id,create_date,status,user_id,"
    ...
    + "create_time from HD_ANNOUNCEMENT Where Schedule_End_Date > '"+startDate+"' " + filterQry;
