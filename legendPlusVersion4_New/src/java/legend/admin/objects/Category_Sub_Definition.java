...
public class Category_Sub_Definition
{
    ...
    public Category_Sub_Definition(String category_id, String sub_category_id, String sub_category_name, String sub_category_description, String status, String user_id, String create_date)
    {
    ...
    public Category_Sub_Definition(String category_id, String sub_category_id, String sub_category_name, String sub_category_description, String status, String user_id)
    {
        CATEGORY_ID = category_id;
        SUB_CATEGORY_ID = sub_category_id;
        SUB_CATEGORY_NAME = sub_category_name;
