...
public class RuleConstraints
{
    ...
    public RuleConstraints(String criteria_ID, String name, String response_day, String response_hour, String response_minute, String resolve_day, String resolve_hour, 
            String resolve_minute, String constraint)
    {
    ...
    public RuleConstraints(String criteria_ID, String name, String response_day, String response_hour, String response_minute, String resolve_day, String resolve_hour, 
            String resolve_minute, String constraint, int alertFreq, String alertStart)
    {
        this.criteria_ID = criteria_ID;
        NAME = name;
        RESPONSE_DAY = response_day;
    ...
    public RuleConstraints(String criteria_ID, String name, String response_day, String response_hour, String response_minute, String resolve_day, String resolve_hour, 
            String resolve_minute, String constraint, String itemName2)
    {
        this.criteria_ID = criteria_ID;
        NAME = name;
        RESPONSE_DAY = response_day;
