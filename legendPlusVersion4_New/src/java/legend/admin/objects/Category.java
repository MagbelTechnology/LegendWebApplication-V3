...
public class Category {
    ...
    public Category(String categoryId, String categoryCode, String categoryName, String categoryAcronym,
            ...
            String insuranceAcct, String licenseLedger, String fuelLedger, String accidentLedger,
            String categoryStatus, String userId, String createDate, String acctType, String currencyId,
            String enforceBarcode, int maxNoDepImprove)
    {
            this.categoryId = categoryId;
		this.categoryCode = categoryCode;
		...
		this.currencyId = currencyId;
                this.enforceBarcode=enforceBarcode;
                this.noOfImproveMnth=maxNoDepImprove;
    }
...
public Category(String categoryId, String categoryCode,
		...
		String fuelLedger, String accidentLedger, String categoryStatus,
		String userId, String createDate, String acctType,
		String currencyId, String enforceBarcode, String categoryType, int maxNoDepImprove) {
	super();
	this.categoryId = categoryId;
	this.categoryCode = categoryCode;
	this.categoryName = categoryName;
...
public Category(String categoryId, String categoryCode,
		...
		String fuelLedger, String accidentLedger, String categoryStatus,
		String userId, String createDate, String acctType,
		String currencyId, String enforceBarcode, String categoryType,String upexassets,String recaldep,String residualchange) {
	super();
	this.categoryId = categoryId;
	this.categoryCode = categoryCode;
	this.categoryName = categoryName;
	...
	this.enforceBarcode = enforceBarcode;
	this.categoryType = categoryType;
	this.upexassets = upexassets;
	this.recaldep = recaldep;
	this.residualchange = residualchange;
}
...
public Category(String categoryId, String categoryCode,
		...
		String fuelLedger, String accidentLedger, String categoryStatus,
		String userId, String createDate, String acctType,
		String currencyId, String enforceBarcode, String categoryType,String upexassets,String recaldep,String residualchange, int maxNoDepImprove) {
	super();
	this.categoryId = categoryId;
	this.categoryCode = categoryCode;
	this.categoryName = categoryName;
    ...
    public String getRecaldep() {
	return recaldep;
    }

    public void setRecaldep(String recaldep) {
	this.recaldep = recaldep;
    }
    
    public String getUpexassets() {
	return upexassets;
    }

    public void setUpexassets(String upexassets) {
	this.upexassets = upexassets;
    }
    
    public String getResidualchange() {
	return residualchange;
    }

    public void setResidualchange(String residualchange) {
	this.residualchange = residualchange;
    }
