 ...
 * @author Olabo
 */
public class UniqueGroupRepostServlet extends HttpServlet {
	...
	if(operation.equals("1"))
      {
          ...
          {
        String bar_codeFound = 
                getCodeName("SELECT bar_code  FROM am_group_asset WHERE bar_code='"+bar_code+"' and group_id !="+grpID+"");
...
if(operation.equals("2"))
      {
          if ((lpo != null)||(lpo != ""))
          {
        	  String lpoFound = getCodeName("SELECT lpo  FROM am_group_asset WHERE lpo='"+lpo+"' and group_id !="+grpID+"");
...
if(operation.equals("3"))
      {
          if ((invNo != null)||(invNo != ""))
          {
       String invFound = getCodeName("SELECT INVOICE_NO  FROM am_invoice_no WHERE INVOICE_NO='"+invNo+"'and group_id !="+grpID+"");
