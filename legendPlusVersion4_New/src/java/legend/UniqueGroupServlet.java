 ...
 * @author Olabo
 */
public class UniqueGroupServlet extends HttpServlet {
	...
	if(operation.equals("1"))
      {
          ...
          {
        	  String bar_codeFound = getCodeName("SELECT bar_code  FROM am_group_asset WHERE bar_code='"+bar_code+"'");
...
if(operation.equals("3"))
      {
          if ((invNo != null)||(invNo != ""))
          {
        	  ...
        	  String invFound = getCodeName("SELECT DISTINCT INVOICE_NO  FROM am_invoice_no WHERE INVOICE_NO='"+invNo+"'");
