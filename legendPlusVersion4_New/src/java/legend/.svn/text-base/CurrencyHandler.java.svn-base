...
public class CurrencyHandler {
    ...
    public java.util.ArrayList getAllExchangeRate() {
        ...
        legend.objects.ExchangeRate exchange = null;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                exchange = new legend.objects.ExchangeRate();
    ...
    public legend.objects.ExchangeRate getExchangeRateByCurrID(String curryid) {
        //java.util.ArrayList _list = new java.util.ArrayList();
        legend.objects.ExchangeRate exchange = null;
        String query = "SELECT [MTID],[currency_id],[create_dt]"
                       + ",[effective_dt],[exchg_rate]"
    ...
    public legend.objects.ExchangeRate getExchangeRateByMTID(String curryid) {
        //java.util.ArrayList _list = new java.util.ArrayList();
        legend.objects.ExchangeRate exchange = null;
        String query = "SELECT [MTID],[currency_id],[create_dt]"
                       + ",[effective_dt],[exchg_rate]"
    ...
    public java.util.ArrayList getAllCurrency() {
        java.util.ArrayList _list = new java.util.ArrayList();
        legend.objects.CurrencyCode curcode = null;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                curcode = new legend.objects.CurrencyCode(currid, isocode,
    ...
    public legend.objects.CurrencyCode getCurrencyByCurrID(String currencyid) {
        //java.util.ArrayList _list = new java.util.ArrayList();
        legend.objects.CurrencyCode curcode = null;
        String query = "SELECT [currency_id],[iso_code],[currency_symbol]"
                       +
    ...
    public legend.objects.CurrencyCode findLocalCurrency() {
        //java.util.ArrayList _list = new java.util.ArrayList();
        legend.objects.CurrencyCode curcode = null;
        String query = "SELECT [currency_id],[iso_code],[currency_symbol]"
                       +
    ...
    public legend.objects.CurrencyCode getCurrencyByMTID(String mtidy) {
        //java.util.ArrayList _list = new java.util.ArrayList();
        legend.objects.CurrencyCode curcode = null;
        String query = "SELECT [currency_id],[iso_code],[currency_symbol]"
                       +
     ...
     * createCurrency
     */
    public boolean createCurrency(legend.objects.CurrencyCode ccode) {
    ...
    public boolean updateCurrency(legend.objects.CurrencyCode ccode) {
    ...
    public boolean createExchangeRate(legend.objects.ExchangeRate ccode) {
    ...
    public boolean updateExchangeRate(legend.objects.ExchangeRate ccode,
                                      boolean dirty) {
    ...
    public boolean logExchangeRate(String cid) {
        ...
        PreparedStatement ps = null;
        boolean done = false;
        legend.objects.ExchangeRate ccode = new legend.objects.ExchangeRate();
