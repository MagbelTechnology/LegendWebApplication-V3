		...
		try {
			if (!userClass.equals("NULL") || userClass!=null){
				...
				//		out.print("<script>alert('Password reset successfull')</script>");
						out.print("<script>alert('Password reset for "+User_Name+" is successful with the New Password = "+newPassword+"')</script>");
						out.print("<script>window.location = 'DocumentHelp.jsp?np=manageUserPassword&status=ACTIVE&me="+newPassword+"&amp;select=ACTIVE'</script>");
